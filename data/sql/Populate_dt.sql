...
insert into dt (DT_GUID, DT_Type, Version_Number, Revision_Type, Data_Type_Term, DEN, Content_Component_DEN, Definition, Content_Component_Definition, Revision_Documentation, Revision_State, Created_By_User_ID, Last_Updated_By_User_ID, Creation_Timestamp, Last_Update_Timestamp) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', '0', 'Binary', 'Binary Object. Type', 'Binary Object. Content', 'CDT V3.1. A binary object is a sequence of binary digits (bits).', 'A finite sequence of binary digits (bits).', '', '1', User_ID, User_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP from user where User_Name = 'oagis' ;
