...
insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Amount', 'Amount. Type', 'Amount. Content', 'CDT V3.1. An amount is a number of monetary units specified in a currency.', 'A number of monetary units.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Binary Object', 'Binary Object. Type', 'Binary Object. Content', 'CDT V3.1. A binary object is a sequence of binary digits (bits).', 'A finite sequence of binary digits (bits).', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
replace a definitive value or text of an attribute.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Date', 'Date. Type', 'Date. Content', 'CDT V3.1. A date is a Gregorian calendar representation in various common resolutions: year, month, week, day.', 'The particular point in the progression of date.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
second.', 'The particular date and time point in the progression of time.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
Week, Day) and Hours, Minutes or Seconds.', 'The particular representation of duration.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Graphic', 'Graphic. Type', 'Graphic. Content', 'CDT V3.. A graphic is a diagram, a graph, mathematical curves, or similar vector based representation in binary notation (octets).', 'A finite sequence of binary digits (bits) for graphics.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
by an agency.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Indicator', 'Indicator. Type', 'Indicator. Content', 'CDT V3.. An indicator is a list of two mutually exclusive Boolean values that express the only possible states of a property.', 'The value of the Indicator.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Measure', 'Measure. Type', 'Measure. Content', 'CDT V3.1. A measure is a numeric value determined by measuring an object along with the specified unit of measure.', 'The numeric value determined by measuring an object.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Name', 'Name. Type', 'Name. Content', 'CDT V3.1. A name is a word or phrase that constitutes the distinctive designation of a person, place, thing or concept.', 'A word or phrase that represents a designation of a person, place, thing or concept.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Number', 'Number. Type', 'Number. Content', 'CDT V3.1. A mathematical number that is assigned or is determined by calculation.', 'Mathematical number that is assigned or is determined by calculation.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Ordinal', 'Ordinal. Type', 'Ordinal. Content', 'CDT V3.1. An ordinal number is an assigned mathematical number that represents order or sequence.', 'An assigned mathematical number that represents order or sequence', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Percent', 'Percent. Type', 'Percent. Content', 'CDT V3.1. A percent is a value representing a fraction of one hundred, expressed as a quotient.', 'Numeric information that is assigned or is determined by percent.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Picture', 'Picture. Type', 'Picture. Content', 'CDT V3.1. A picture is a visual representation of a person, object, or scene in binary notation (octets).', 'A finite sequence of binary digits (bits) for pictures.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
fractions.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Rate', 'Rate. Type', 'Rate. Content', 'CDT V3.1. A rate is a quantity, amount, frequency, or dimensionless factor, measured against an independent base unit, expressed as a quotient.', 'The numerical value of the rate.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
same unit of measure or currency.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
sounds.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
language.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
...
value.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',REPLACE(UUID(),'-','')), '0', '1.0', 'Video', 'Video. Type', 'Video. Content', 'CDT V3.1. A video is a recording, reproducing or broadcasting of visual images on magnetic tape or digitally in binary notation (octets).', 'A finite sequence of binary digits (bits) for videos.', , app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, true, false from app_user where login_id = 'oagis' ;
