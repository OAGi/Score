...
insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Amount', 'Amount. Type', 'Amount. Content', 'CDT V3.1. An amount is a number of monetary units specified in a currency.', 'A number of monetary units.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Binary Object', 'Binary Object. Type', 'Binary Object. Content', 'CDT V3.1. A binary object is a sequence of binary digits (bits).', 'A finite sequence of binary digits (bits).', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
replace a definitive value or text of an attribute.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
second.', 'The particular date and time point in the progression of time.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
Week, Day) and Hours, Minutes or Seconds.', 'The particular representation of duration.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Graphic', 'Graphic. Type', 'Graphic. Content', 'CDT V3.. A graphic is a diagram, a graph, mathematical curves, or similar vector based representation in binary notation (octets).', 'A finite sequence of binary digits (bits) for graphics.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
by an agency.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Number', 'Number. Type', 'Number. Content', 'CDT V3.1. A mathematical number that is assigned or is determined by calculation.', 'Mathematical number that is assigned or is determined by calculation.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Ordinal', 'Ordinal. Type', 'Ordinal. Content', 'CDT V3.1. An ordinal number is an assigned mathematical number that represents order or sequence.', 'An assigned mathematical number that represents order or sequence', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
fractions.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;

insert into dt (guid, type, version_num, data_type_term, den, content_component_den, definition, content_component_definition, revision_doc, state, created_by, owner_user_id, last_updated_by, creation_timestamp, last_update_timestamp, revision_num, revision_tracking_num, revision_action, is_deprecated) 
	select concat('oagis-id-',sys_guid()), '0', '1.0', 'Rate', 'Rate. Type', 'Rate. Content', 'CDT V3.1. A rate is a quantity, amount, frequency, or dimensionless factor, measured against an independent base unit, expressed as a quotient.', 'The numerical value of the rate.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
same unit of measure or currency.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
sounds.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
language.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
...
value.', '', '1', app_user_id, app_user_id, app_user_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, '1', '0' from app_user where login_id = 'oagis' ;
