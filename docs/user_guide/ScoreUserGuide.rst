...
one file. This functionality creates OpenAPI 3.x persistence layer in the Score database and provides 
UI to support API Specification Management.  

Currently, Score provides the OpenAPI document functionality to end users only. 
Developers won't see this functionality once login as developer. The end users can view, create,
edit or discard OpenAPI Document through the OpenAPI Document menu under the BIE menu.
...
3. Locate the desired OpenAPI Document. Use the *Title*, *Description*,  *Updater*, 
   *Updated start date*, or *Updated end date* search filters to help located the desired 
