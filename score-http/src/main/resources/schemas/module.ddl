...
(
    ...
    `type`                  varchar(45)  NOT NULL COMMENT 'This is a type column that indicates whether the module is FILE or DIRECTORY.',
    `path`                  text         NOT NULL COMMENT 'Absolute path to the module.',
    `name`                  varchar(100) NOT NULL COMMENT 'This is the filename of the module. The reason to not including the extension is that the extension maybe dependent on the expression. For XML schema, ''.xsd'' maybe added; or for JSON, ''.json'' maybe added as the file extension.',
