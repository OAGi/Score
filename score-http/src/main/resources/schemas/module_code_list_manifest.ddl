...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='This table assigns a CODE_LIST_MANIFEST to a MODULE within a MODULE_SET_RELEASE, indicating the physical file into which the code list is generated during the expression generation.';