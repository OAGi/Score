CREATE TABLE `bbiep`
(
    `bbiep_id`                  bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'A internal, primary database key of a BBIEP.',
    ...
    `definition`                text         DEFAULT NULL COMMENT 'Definition to override the BCCP''s Definition. If NULL, it means that the definition should be inherited from the based CC.',
