...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='This table assigns BLOB_CONTENT_MANIFEST records to a MODULE within a MODULE_SET_RELEASE, associating each imported whole-schema blob with the physical file into which it is emitted during schema generation and export.';