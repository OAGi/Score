...
(
    ...
    `definition`                          text         DEFAULT NULL COMMENT 'Description of the agency identification list value.',
    ...
    `is_deprecated`                       tinyint(1) DEFAULT 0 COMMENT 'Indicates whether the agency id list value is deprecated and should not be reused (i.e., no new reference to this record should be allowed).',
    ...
    `created_by`                          bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the APP_USER table. It indicates the user who created the agency ID list value.',
    ...
    `last_updated_by`                     bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the APP_USER table. It identifies the user who last updated the agency ID list value.',
    `creation_timestamp`                  datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'Timestamp when the agency ID list value was created.',
    `last_update_timestamp`               datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'Timestamp when the agency ID list value was last updated.',
