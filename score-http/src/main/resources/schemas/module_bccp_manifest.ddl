...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='This is an intersection table that assigns a BCCP_MANIFEST to a MODULE within a MODULE_SET_RELEASE, indicating the physical file into which the BCCP will be generated during the expression generation.';