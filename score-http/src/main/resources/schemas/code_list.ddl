...
(
    ...
    `extensible_indicator`     tinyint(1) NOT NULL COMMENT 'This is a flag to indicate whether the code list is extensible, i.e., whether additional code values may be added or the code list may be further derived. When false, the code list is final.',
    ...
    `state`                    varchar(20)  DEFAULT NULL COMMENT 'Deleted, WIP, Draft, QA, Candidate, Production, Release Draft, Published. This the revision life cycle state of the code list.\n\nState change can''t be undone. But the history record can still keep the records of when the state was changed.',
