...
(
    ...
    `owner_dt_id`           bigint(20) unsigned DEFAULT NULL COMMENT 'Foreign key to the DT table indicating the data type, to which this supplementary component belongs.',
    `cardinality_min`       int(11) NOT NULL DEFAULT 0 COMMENT 'The minimum occurrence constraint associated with the supplementary component. The valid values are zero or one.',
    ...
    `created_by`            bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the APP_USER table. It indicates the user who created the supplementary component.',
    ...
    `last_updated_by`       bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the APP_USER table. It identifies the user who last updated the supplementary component.',
    `creation_timestamp`    datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'Timestamp when the supplementary component was created.',
    `last_update_timestamp` datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'Timestamp when the supplementary component was last updated.',
