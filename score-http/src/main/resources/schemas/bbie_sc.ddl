...
(
    ...
    `cardinality_max`            int(11) NOT NULL COMMENT 'Maximum occurrence constraint of the BBIE SC. A valid value is 0 or 1.',
    ...
    `example`                    text         DEFAULT NULL COMMENT 'An example value for the BBIE SC.',
