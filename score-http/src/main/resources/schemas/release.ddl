...
(
    ...
    `release_num`           varchar(45) DEFAULT NULL COMMENT 'Release number such as 10.0, 10.1, etc. ',
    ...
    `created_by`            bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the APP_USER table identifying the user who created the record.',
