...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='This table assigns XBT_MANIFEST components (the XML Schema and OAGIS built-in types) to a MODULE within a MODULE_SET_RELEASE, so that they are generated into the appropriate physical schema file during expression generation.';