...
(
    `top_level_asbiep_id`        bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'An internal, primary database key of a TOP_LEVEL_ASBIEP record.',
    ...
    `last_update_timestamp`      datetime(6) NOT NULL DEFAULT current_timestamp(6) COMMENT 'The timestamp when any of the related BIE records was last updated.',
    ...
    `release_id`                 bigint(20) unsigned NOT NULL COMMENT 'Foreign key to the RELEASE table. It identifies the release, for which this top-level ASBIEP is associated.',
    `version`                    varchar(45) DEFAULT NULL COMMENT 'This column holds a version number assigned by the user. This column is only used by the top-level ASBIEP. No format of version is enforced.',
    ...
    `state`                      varchar(20) DEFAULT NULL COMMENT 'The life cycle state of the top-level ASBIEP. Possible values are Initiating, WIP, QA, and Production.',
