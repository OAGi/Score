...
public class BdtPriRestri extends TableImpl<BdtPriRestriRecord> {
    ...
    private static final long serialVersionUID = -573764733;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.BDT_PRI_RESTRI_BDT_PRI_RESTRI_AGENCY_ID_LIST_ID_FK, Indexes.BDT_PRI_RESTRI_BDT_PRI_RESTRI_BDT_ID_FK, Indexes.BDT_PRI_RESTRI_BDT_PRI_RESTRI_CDT_AWD_PRI_XPS_TYPE_MAP_ID_FK, Indexes.BDT_PRI_RESTRI_BDT_PRI_RESTRI_CODE_LIST_ID_FK, Indexes.BDT_PRI_RESTRI_PRIMARY);
    }
    ...
    public Dt dt() {
        return new Dt(this, Keys.BDT_PRI_RESTRI_BDT_ID_FK);
    }

    public CdtAwdPriXpsTypeMap cdtAwdPriXpsTypeMap() {
        return new CdtAwdPriXpsTypeMap(this, Keys.BDT_PRI_RESTRI_CDT_AWD_PRI_XPS_TYPE_MAP_ID_FK);
    }

    public CodeList codeList() {
        return new CodeList(this, Keys.BDT_PRI_RESTRI_CODE_LIST_ID_FK);
    }

    public AgencyIdList agencyIdList() {
        return new AgencyIdList(this, Keys.BDT_PRI_RESTRI_AGENCY_ID_LIST_ID_FK);
    }
