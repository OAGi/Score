...
public class Asbiep extends TableImpl<AsbiepRecord> {
    ...
    private static final long serialVersionUID = 1996451125;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.ASBIEP_ASBIEP_BASED_ASCCP_ID_FK, Indexes.ASBIEP_ASBIEP_CREATED_BY_FK, Indexes.ASBIEP_ASBIEP_LAST_UPDATED_BY_FK, Indexes.ASBIEP_ASBIEP_OWNER_TOP_LEVEL_ASBIEP_ID_FK, Indexes.ASBIEP_ASBIEP_ROLE_OF_ABIE_ID_FK, Indexes.ASBIEP_PRIMARY);
    }
    ...
    public List<ForeignKey<AsbiepRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AsbiepRecord, ?>>asList(Keys.ASBIEP_BASED_ASCCP_ID_FK, Keys.ASBIEP_ROLE_OF_ABIE_ID_FK, Keys.ASBIEP_CREATED_BY_FK, Keys.ASBIEP_LAST_UPDATED_BY_FK, Keys.ASBIEP_OWNER_TOP_LEVEL_ASBIEP_ID_FK);
    }
