...
public class BbiepRecord extends UpdatableRecordImpl<BbiepRecord> implements Record11<ULong, String, ULong, String, String, String, ULong, ULong, Timestamp, Timestamp, ULong> {
     ...
     */
    public BbiepRecord(ULong bbiepId, String guid, ULong basedBccpId, String definition, String remark, String bizTerm, ULong createdBy, ULong lastUpdatedBy, Timestamp creationTimestamp, Timestamp lastUpdateTimestamp, ULong ownerTopLevelAsbiepId) {
        super(Bbiep.BBIEP);
