...
public class AppOauth2User extends TableImpl<AppOauth2UserRecord> {
    ...
    private static final long serialVersionUID = 1098859652;
     ...
     */
    public final TableField<AppOauth2UserRecord, Timestamp> CREATION_TIMESTAMP = createField(DSL.name("creation_timestamp"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "Timestamp when this record is created.");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.APP_OAUTH2_USER_APP_OAUTH2_USER_APP_USER_ID_FK, Indexes.APP_OAUTH2_USER_APP_OAUTH2_USER_UK1, Indexes.APP_OAUTH2_USER_PRIMARY);
    }
