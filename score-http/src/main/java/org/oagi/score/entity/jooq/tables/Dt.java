...
public class Dt extends TableImpl<DtRecord> {
    ...
    private static final long serialVersionUID = 491107867;
...
The column name is specific to BDT because, the column does not apply to CDT.
    ...
    public org.oagi.score.entity.jooq.tables.Dt dtPreviousVersionDtIdFk() {
        return new org.oagi.score.entity.jooq.tables.Dt(this, Keys.DT_PREVIOUS_VERSION_DT_ID_FK);
    }

    public org.oagi.score.entity.jooq.tables.Dt dtBasedDtIdFk() {
        return new org.oagi.score.entity.jooq.tables.Dt(this, Keys.DT_BASED_DT_ID_FK);
    }
    ...
    public org.oagi.score.entity.jooq.tables.Dt dtCurrentBdtIdFk() {
        return new org.oagi.score.entity.jooq.tables.Dt(this, Keys.DT_CURRENT_BDT_ID_FK);
    }
