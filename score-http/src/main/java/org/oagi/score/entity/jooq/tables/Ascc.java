...
public class Ascc extends TableImpl<AsccRecord> {
    ...
    private static final long serialVersionUID = 334452144;
...
The value of this column for the current record should be left NULL.
    ...
    public org.oagi.score.entity.jooq.tables.Ascc ascc() {
        return new org.oagi.score.entity.jooq.tables.Ascc(this, Keys.ASCC_CURRENT_ASCC_ID_FK);
    }
