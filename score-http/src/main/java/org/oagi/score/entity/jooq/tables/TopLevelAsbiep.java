...
public class TopLevelAsbiep extends TableImpl<TopLevelAsbiepRecord> {
     ...
     */
    public final TableField<TopLevelAsbiepRecord, Integer> STATE = createField(DSL.name("state"), org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private TopLevelAsbiep(Name alias, Table<TopLevelAsbiepRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("This table indexes the ASBIEP which is a top-level ASBIEP. This table and the owner_top_level_asbiep_id column in all BIE tables allow all related BIEs to be retrieved all at once speeding up the profile BOD transactions."));
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TOP_LEVEL_ASBIEP_PRIMARY, Indexes.TOP_LEVEL_ASBIEP_TOP_LEVEL_ASBIEP_ASBIEP_ID_FK, Indexes.TOP_LEVEL_ASBIEP_TOP_LEVEL_ASBIEP_LAST_UPDATED_BY_FK, Indexes.TOP_LEVEL_ASBIEP_TOP_LEVEL_ASBIEP_OWNER_USER_ID_FK, Indexes.TOP_LEVEL_ASBIEP_TOP_LEVEL_ASBIEP_RELEASE_ID_FK);
    }
