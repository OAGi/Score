...
import org.oagi.score.gateway.http.common.repository.jooq.entity.tables.AsccBizterm.AsccBiztermPath;
...
public class AsbieBizterm extends TableImpl<AsbieBiztermRecord> {
    ...
    public List<ForeignKey<AsbieBiztermRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ASBIE_BIZTERM_ASBIE_FK, Keys.ASBIE_BIZTERM_ASCC_BIZTERM_FK);
    }
