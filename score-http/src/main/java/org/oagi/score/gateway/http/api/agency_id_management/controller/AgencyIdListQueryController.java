...
@RestController
@Tag(name = "Agency ID List - Queries", description = "API for retrieving agency ID list-related data")
@RequestMapping("/agency-id-lists")
public class AgencyIdListQueryController {
    ...
    public List<AgencyIdListSummaryRecord> getAgencyIdListSummaryList(
        ...
        return agencyIdListQueryService.getAgencyIdListSummaryList(sessionService.asScoreUser(user), releaseId);
    }

    @GetMapping(value = "/{agencyIdListManifestId:[\\d]+}")
    ...
    public AgencyIdListDetailsRecord getPrevAgencyIdListDetails(
        ...
        return agencyIdListQueryService.getPrevAgencyIdListDetails(
                sessionService.asScoreUser(user), agencyIdListManifestId);
    }

    @GetMapping()
    public PageResponse<AgencyIdListListEntryRecord> getAgencyIdListList(
            @AuthenticationPrincipal AuthenticatedPrincipal user,
        ...
        AgencyIdListListFilterCriteria filterCriteria = new AgencyIdListListFilterCriteria(
                libraryId, releaseId,
        ...
        var resultAndCount = agencyIdListQueryService.getAgencyIdListList(sessionService.asScoreUser(user), filterCriteria, pageRequest);

        PageResponse<AgencyIdListListEntryRecord> response = new PageResponse<>();
    ...
    public boolean checkUniqueness(
            ...
            @RequestParam(name = "agencyIdListManifestId", required = false)
            AgencyIdListManifestId agencyIdListManifestId,
        ...
        return agencyIdListQueryService.hasSameAgencyIdList(sessionService.asScoreUser(user),
    ...
    public boolean checkNameUniqueness(
        ...
        return agencyIdListQueryService.hasSameNameAgencyIdList(sessionService.asScoreUser(user),
