package org.oagi.score.gateway.http.api.integration_management.controller;
...
import org.oagi.score.gateway.http.api.integration_management.handler.GitHubWebhookEventDispatcher;
import org.oagi.score.gateway.http.api.integration_management.service.GitHubIntegrationService;
import org.oagi.score.gateway.http.api.integration_management.service.GitHubIssueLinkService;
...
public class GitHubIntegrationController {
    ...
    private static CcType ccType(String type) {
        ...
        if (ccType == null || !SUPPORTED_TYPES.contains(ccType)) {
            throw new UnsupportedOperationException("Unsupported component type for GitHub issue linking: " + type);
        }
        return ccType;
    }
