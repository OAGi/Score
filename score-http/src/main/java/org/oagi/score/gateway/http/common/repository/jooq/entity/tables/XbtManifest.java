...
import org.oagi.score.gateway.http.common.repository.jooq.entity.tables.records.XbtManifestRecord;
...
public class XbtManifest extends TableImpl<XbtManifestRecord> {
    ...
    public BbieScPath bbieSc() {
        if (_bbieSc == null)
            _bbieSc = new BbieScPath(this, null, Keys.BBIE_SC_XBT_MANIFEST_ID_FK.getInverseKey());
    ...
    public BbiePath bbie() {
        if (_bbie == null)
            _bbie = new BbiePath(this, null, Keys.BBIE_XBT_MANIFEST_ID_FK.getInverseKey());
    ...
    public DtAwdPriPath dtAwdPri() {
        if (_dtAwdPri == null)
            _dtAwdPri = new DtAwdPriPath(this, null, Keys.DT_AWD_PRI_XBT_MANIFEST_ID_FK.getInverseKey());
    ...
    public DtScAwdPriPath dtScAwdPri() {
        if (_dtScAwdPri == null)
            _dtScAwdPri = new DtScAwdPriPath(this, null, Keys.DT_SC_AWD_PRI_XBT_MANIFEST_ID_FK.getInverseKey());
