...
public class Library extends TableImpl<LibraryRecord> {
    ...
    /**
     * The column <code>oagi.library.type</code>. A type of the library.
     */
    public final TableField<LibraryRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(100).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "A type of the library.");
    ...
    /**
     * The column <code>oagi.library.state</code>. Current state of the library.
     */
    public final TableField<LibraryRecord, String> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR(20).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "Current state of the library.");

    /**
     * The column <code>oagi.library.is_read_only</code>. Indicates if the
