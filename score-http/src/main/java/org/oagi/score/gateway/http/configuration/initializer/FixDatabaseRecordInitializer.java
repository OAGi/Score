...
import static org.oagi.score.gateway.http.api.application_management.service.ApplicationConfigurationProperties.NAVBAR_BRAND_CONFIG_PARAM_NAME;
...
public class FixDatabaseRecordInitializer implements InitializingBean {
    ...
    private void insertDefaultBrandSVG() {
        String defaultBrandSVG = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"126px\" height=\"26px\" viewBox=\"0 0 126 26\"\n" +
                ...
                "      </svg>";
        repositoryFactory.configurationCommandRepository(sessionService.getScoreSystemUser())
                .insertConfigurationIfNotExists(NAVBAR_BRAND_CONFIG_PARAM_NAME, defaultBrandSVG);
    }
