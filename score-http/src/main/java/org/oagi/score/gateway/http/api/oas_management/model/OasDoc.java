...
public class OasDoc extends Auditable {
    ...
    public OasDoc(BigInteger oasDocId, String guid, String openAPIVersion, String title, String description, String termsOfService, String version, String contactName, String contactUrl, String contactEmail, String licenseName, String licenseUrl, Date lastUpdateTimestamp, Date creationTimestamp, UserSummaryRecord createdBy, UserSummaryRecord lastUpdatedBy) {
        this.oasDocId = oasDocId;
        this.guid = guid;
        this.openAPIVersion = openAPIVersion;
        this.title = title;
