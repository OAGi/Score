...
public class DTRepository implements ScoreRepository<DT> {
    ...
    private SelectOnConditionStep<Record> getSelectOnConditionStep() {
        return dslContext.select(
                ...
                Tables.DT.QUALIFIER,
                Tables.DT.FACET_MIN_LENGTH,
                Tables.DT.FACET_MAX_LENGTH,
                Tables.DT.FACET_PATTERN,
                Tables.DT.FACET_MIN_INCLUSIVE,
                Tables.DT.FACET_MIN_EXCLUSIVE,
                Tables.DT.FACET_MAX_INCLUSIVE,
                Tables.DT.FACET_MAX_EXCLUSIVE,
