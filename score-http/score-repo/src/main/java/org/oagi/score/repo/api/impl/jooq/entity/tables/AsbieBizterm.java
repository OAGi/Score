...
public class AsbieBizterm extends TableImpl<AsbieBiztermRecord> {
     ...
     */
    public final TableField<AsbieBiztermRecord, Byte> PRIMARY_INDICATOR = createField(DSL.name("primary_indicator"), SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)), this, "The indicator shows if the business term is primary for the assigned ASBIE.");
