...
public class ModuleAsccpManifestRecord extends UpdatableRecordImpl<ModuleAsccpManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.module_asccp_manifest_id</code>. Primary key.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.module_asccp_manifest_id</code>. Primary key.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.module_set_release_id</code>. A foreign key of the module set release record.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.module_set_release_id</code>. A foreign key of the module set release record.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.asccp_manifest_id</code>. A foreign key of the asccp manifest record.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.asccp_manifest_id</code>. A foreign key of the asccp manifest record.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.created_by</code>. Foreign key to the APP_USER table. It indicates the user who created this record.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.created_by</code>. Foreign key to the APP_USER table. It indicates the user who created this record.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.last_updated_by</code>. Foreign key to the APP_USER table referring to the last user who updated the record.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.last_updated_by</code>. Foreign key to the APP_USER table referring to the last user who updated the record.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.creation_timestamp</code>. The timestamp when the record was first created.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.creation_timestamp</code>. The timestamp when the record was first created.
     */
    ...
    /**
     * Setter for <code>oagi.module_asccp_manifest.last_update_timestamp</code>. The timestamp when the record was last updated.
     */
    ...
    /**
     * Getter for <code>oagi.module_asccp_manifest.last_update_timestamp</code>. The timestamp when the record was last updated.
     */
