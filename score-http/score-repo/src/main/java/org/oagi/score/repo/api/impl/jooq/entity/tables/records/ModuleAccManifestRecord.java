...
public class ModuleAccManifestRecord extends UpdatableRecordImpl<ModuleAccManifestRecord> implements Record8<ULong, ULong, ULong, ULong, ULong, ULong, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public ModuleAccManifestRecord value5(ULong value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public ModuleAccManifestRecord value6(ULong value) {
    ...
    @Override
    public ModuleAccManifestRecord values(ULong value1, ULong value2, ULong value3, ULong value4, ULong value5, ULong value6, LocalDateTime value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
