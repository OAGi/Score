...
public class Message extends TableImpl<MessageRecord> {
    ...
    /**
     * The column <code>oagi.message.sender_id</code>. The user who created this record.
     */
    ...
    /**
     * The column <code>oagi.message.creation_timestamp</code>. The timestamp when the record was first created.
     */
    ...
    public List<ForeignKey<MessageRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<MessageRecord, ?>>asList(Keys.MESSAGE_SENDER_ID_FK, Keys.MESSAGE_RECIPIENT_ID_FK);
    }
