...
public class BCCPChangeDTDialogImpl extends SearchBarPageImpl implements BCCPChangeDTDialog {
    ...
    public BCCPChangeDTDialogImpl(BCCPViewEditPageImpl parent) {
    ...
    public boolean isOpened() {
        ...
        assert "Select DT to update BCCP".equals(getText(title.findElement(By.tagName("span"))));
        return true;
    }
