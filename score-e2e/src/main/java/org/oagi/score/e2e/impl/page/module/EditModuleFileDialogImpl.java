...
public class EditModuleFileDialogImpl implements EditModuleFileDialog {
    ...
    private static final By MODULE_FILE_VERSION_FIELD_LOCATOR =
            By.xpath("//mat-dialog-content//mat-label[contains(text(), \"Version\")]//ancestor::mat-mdc-form-field//input");
    private static final By NAMESPACE_SELECT_FIELD_LOCATOR =
            By.xpath("//mat-dialog-content//*[text()= \"Namespace\"]//ancestor::mat-mdc-form-field[1]//mat-select/div/div[1]");
