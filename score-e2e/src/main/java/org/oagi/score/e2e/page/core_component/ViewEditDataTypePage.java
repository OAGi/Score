...
/**
 * An interface of 'View/Edit Data Type' page.
 */
public interface ViewEditDataTypePage extends Page, SearchBarPage {
    ...
    /**
     * Return the UI element of the 'New Data Type' button.
     *
     * @return the UI element of the 'New Data Type' button
     */
    WebElement getNewDataTypeButton();

    /**
     * Open the 'Select based DT' dialog.
     *
     * @param branch Branch text
     * @return the 'Select based DT' dialog
     */
