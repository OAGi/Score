...
public interface ASCCPCreateDialog extends Dialog, SearchBarPage {
    ...
    /**
     * Return the UI element of the 'Tag' select field.
     *
     * @return the UI element of the 'Tag' select field
     */
    WebElement getTagSelectField();

    /**
     * Set the 'Tag' select field with the given text.
     *
     * @param tag 'BOD', 'Noun' or 'Verb'
     */
