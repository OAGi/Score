...
public class AccountPageImpl extends BaseSearchBarPageImpl implements AccountPage {
    ...
    public AccountPageImpl(BasePage parent) {
        super(parent);
    }
    ...
    public void openPage() {
        ...
        getDriver().get(url);
        assert "Account".equals(getText(getTitle()));
    }
