...
/**
 * An interface of 'Create OpenAPI Document' page.
 */
public interface CreateOpenAPIDocumentPage extends Page {
     ...
     * @return the UI element of the 'Create' button
     */
    WebElement getCreateButton(boolean enabled);

    /**
     * Create a new OpenAPI document.
     *
     * @return the 'OpenAPI Document' page.
     */
    OpenAPIDocumentPage create();
