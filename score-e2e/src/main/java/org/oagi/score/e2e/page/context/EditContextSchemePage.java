...
/**
 * An interface of 'Edit Context Scheme' page.
 */
public interface EditContextSchemePage extends Page {
     ...
     */
    void updateContextScheme(ContextSchemeObject contextScheme);

    /**
     * Update a context scheme with a context category.
     *
     * @param contextCategory context category
     * @param contextScheme   context scheme
     */
    void updateContextScheme(ContextCategoryObject contextCategory,
    ...
    /**
     * Discard the context scheme.
     *
     * @return 'View/Edit Context Scheme' page object
     */
    ViewEditContextSchemePage discard();
