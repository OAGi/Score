...
public interface BCCPChangeDTDialog extends Dialog, SearchBarPage {
    ...
    /**
     * Cancel updating BCCP's BDT.
     *
     * @return the BCCP page object
     */
    BCCPViewEditPage cancel();
     ...
     * Update the BDT.
     *
     * @param bdtDen BDT DEN
     * @return the BCCP page object
     */
    BCCPViewEditPage update(String bdtDen);
}
