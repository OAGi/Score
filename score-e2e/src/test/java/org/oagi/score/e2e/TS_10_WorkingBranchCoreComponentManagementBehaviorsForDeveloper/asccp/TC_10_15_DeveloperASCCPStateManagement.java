...
public class TC_10_15_DeveloperASCCPStateManagement extends BaseTest {
    ...
    @Test
    @DisplayName("TC_10_15_TA_1")
    public void wip_asccp_can_move_to_draft() {
    ...
    @Test
    @DisplayName("TC_10_15_TA_2")
    public void draft_asccp_can_return_to_wip() {
    ...
    @Test
    @DisplayName("TC_10_15_TA_3")
    public void draft_asccp_can_move_to_candidate() {
    ...
    @Test
    @DisplayName("TC_10_15_TA_4")
    public void candidate_asccp_can_return_to_wip() {
        AppUserObject developer = getAPIFactory().getAppUserAPI().createRandomDeveloperAccount(false);
        thisAccountWillBeDeletedAfterTests(developer);
