...
public class TC_1_2_OAGISDevelopersAuthorizedFunctionalities extends BaseTest {
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - View/Edit BIE Menu)")
    public void test_view_edit_bie_menu_developer() {
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - Create BIE Menu)")
    public void test_create_bie_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - Copy BIE Menu)")
    public void test_copy_bie_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - Uplift BIE Menu)")
    public void test_uplift_bie_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - Express BIE Menu)")
    public void test_express_bie_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - View/Edit Code List Menu)")
    public void test_bie_view_edit_code_list_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    @Test
    @DisplayName("TC_1_2_TA_1_1 (BIE - Uplift Code List Menu - Disabled)")
    public void test_bie_uplift_code_list_menu_developer() {
        HomePage homePage = loginPage().signIn(appUser.getLoginId(), appUser.getPassword());
        BIEMenu bieMenu = homePage.getBIEMenu();
    ...
    public void test_login_id_settings_menu_developer() {
        ...
        WebElement title = settingsAccountPage.getTitle();
        assertTrue(title.isDisplayed());
        String titleText = title.getText();

        homePage.openPage();
        settingsAccountPage.openPage();
        assertEquals(settingsAccountPage.getTitle().getText(), titleText);
    }
