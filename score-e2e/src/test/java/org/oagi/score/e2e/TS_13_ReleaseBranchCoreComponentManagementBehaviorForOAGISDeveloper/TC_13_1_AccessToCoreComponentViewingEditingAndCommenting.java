    ...
    public void test_TA_1() {
        ...
        for (ACCObject acc : accForTesting){
            ...
            if (owner.isDeveloper() && !acc.getState().equals("Published")){
                assertThrows(TimeoutException.class, () -> {viewEditCoreComponentPage.getTableRecordByValue(acc.getDen());});
            }else{
                assertDoesNotThrow(() -> {viewEditCoreComponentPage.getTableRecordByValue(acc.getDen());});
            }
        }
        ...
        for (BCCPObject bccp : bccpForTesting){
            ...
            if (owner.isDeveloper() && !bccp.getState().equals("Published")){
                assertThrows(TimeoutException.class, () -> {viewEditCoreComponentPage.getTableRecordByValue(bccp.getDen());});
            }else{
                assertDoesNotThrow(() -> {viewEditCoreComponentPage.getTableRecordByValue(bccp.getDen());});
            }
        }
        ...
        for (BCCObject bcc : bccForTesting){
            ...
            if (owner.isDeveloper() && !bcc.getState().equals("Published")){
                assertThrows(TimeoutException.class, () -> {viewEditCoreComponentPage.getTableRecordByValue(bcc.getDen());});
            }else{
                assertDoesNotThrow(() -> {viewEditCoreComponentPage.getTableRecordByValue(bcc.getDen());});
            }
        }
        for (ASCCPObject asccp : asccpForTesting){
            ...
            if (owner.isDeveloper() && !asccp.getState().equals("Published")){
                assertThrows(TimeoutException.class, () -> {viewEditCoreComponentPage.getTableRecordByValue(asccp.getDen());});
            }else{
                assertDoesNotThrow(() -> {viewEditCoreComponentPage.getTableRecordByValue(asccp.getDen());});
            }
        }
        for (ASCCObject ascc : asccForTesting){
            ...
            if (owner.isDeveloper() && !ascc.getState().equals("Published")){
                assertThrows(TimeoutException.class, () -> {viewEditCoreComponentPage.getTableRecordByValue(ascc.getDen());});
            }else{
                assertDoesNotThrow(() -> {viewEditCoreComponentPage.getTableRecordByValue(ascc.getDen());});
            }
        }
    }
