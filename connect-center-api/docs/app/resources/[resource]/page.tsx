...
const RESOURCE_CONCEPTS: Record<string, ResourceConcept> = {
  ...
  libraries: {
    ...
    endpointUsage: [
      ...
      'Use `get_library` when you need the details of one specific library, such as its organization, domain, state, or whether it is marked as default.',
  ...
  code_lists: {
    ...
    endpointUsage: [
      ...
      'Use `create_code_list` to create a new code list in the release branch allowed for your role, optionally deriving it from an existing base code list.',
      'Use `update_code_list` to change mutable code list fields while the code list is in `WIP`.',
