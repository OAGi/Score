...
(
    ...
    `terms_of_service`      text        DEFAULT NULL COMMENT 'A URL to the Terms of Service for the API. MUST be in the format of a URL.',
    ...
    `contact_url`           text        DEFAULT NULL COMMENT 'The URL pointing to the contact information. MUST be in the format of a URL.',
    ...
    `license_url`           text         DEFAULT NULL COMMENT 'A URL to the license used for the API. MUST be in the format of a URL.',
...
(
    ...
    `ref`                   text       DEFAULT NULL COMMENT 'A URL that points to the literal example. This provides the capability to reference examples that cannot easily be included in JSON or YAML documents. The value field and externalValue field are mutually exclusive.',
...
(
    ...
    `url`                   text      NOT NULL COMMENT 'REQUIRED. The URL for the target documentation. Value MUST be in the format of a URL.',
...
(
    ...
    `url`                   text     NOT NULL COMMENT 'REQUIRED. A URL to the target host. This URL supports Server Variables and MAY be relative, to indicate that the host location is relative to the location where the OpenAPI document is being served. Variable substitutions will be made when a variable is named in {brackets}.',
