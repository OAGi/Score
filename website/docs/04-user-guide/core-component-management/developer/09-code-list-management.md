...
All filters on the Code List have the same meaning as those described in [How to Search and Filter for a Core Component](../03-search-and-browse-cc-library.md#how-to-search-and-filter-for-a-core-component), except that some filters do not exist on the Code List page and the Code List page has Name instead of DEN.
The [CC Specification](https://www.unece.org/cefact/codesfortrade/ccts_index.html) does not have Code List as one of the Registry Classes and hence Code List does not have DEN specification.
...
1. [Find a code list](./10-agency-id-list-management.md#find-an-agency-id-list).
...
4. [Detail of the code list can be updated including add/change code
   list values.](#edit-detail-of-a-brand-new-code-list)
...
1. Make sure you are on the Working branch. Open the Edit Code List
   ...
   list](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list). The code list has to be
   ...
   editable. The fields in the detail pane may be updated as follows.
    ...
    3. *Agency ID List* and *Agency ID List Value*. This combination of
       ...
       List](./10-agency-id-list-management.md#revise-an-agency-id-list) and [add a new
       value](./10-agency-id-list-management.md#add-a-brand-new-agency-id-list-value-to-the-agency-id-list).
    ...
    5. *Namespace*. Select a standard namespace from the dropdown list.
       See the [Namespace
       Management](./01-core-component-management-tips-and-tricks.md) section
...
3. The developer may also want to perform these other actions on the
   code list:
    ...
    1. [Add a brand-new code list value to the code
       list](./10-agency-id-list-management.md#add-a-brand-new-agency-id-list-value-to-the-agency-id-list)

    2. [Remove a brand-new code list value from the code
       list](./10-agency-id-list-management.md#remove-a-brand-new-agency-id-list-value-from-the-agency-id-list)

    3. [Edit detail of a brand-new code list
       value](#edit-detail-of-a-brand-new-code-list-value)

    4. [Change a code list state](./10-agency-id-list-management.md#change-an-agency-id-list-state)

    5. [Transfer ownership of a code
       list](./10-agency-id-list-management.md#transfer-ownership-of-an-agency-id-list)
...
1. At the bottom of the ["Edit Code List"
   page](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list), click the "Add" button.
...
1. In the "Code List Values" table on the ["Edit Code List"
   page](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list), click the checkboxes in
...
1. In the Code List Values table on the ["Edit Code List"
   page](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list), click on the row of the
...
1. Make sure you are on the *Working* branch. [Open the "Edit Code List"
   page](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list) of a code list in the
   Published state.
...
4. [Detail of the code list can be updated including add/change code
   list values.](#edit-detail-of-a-revised-code-list)
...
1. Open the "Edit Code List detail" page according to [View detail of a
   code list](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list). The code list has
...
3. The developer may also want to perform these other actions on the
   code list:
    ...
    4. [Revise detail of a code list
       value](./10-agency-id-list-management.md#revise-detail-of-an-agency-id-list-value)

    5. [Change a code list state](./10-agency-id-list-management.md#change-an-agency-id-list-state)
...
1. In the Code List Values table on the ["Edit Code List"
   page](./10-agency-id-list-management.md#view-detail-of-an-agency-id-list) of a code list with
...
Other developers (or the owner himself) can however restore the code list - see [Restore a deleted code list](./10-agency-id-list-management.md#delete-a-brand-new-agency-id-list).
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   list](./10-agency-id-list-management.md#find-an-agency-id-list) for help in locating a code list.
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   code list](./10-agency-id-list-management.md#find-an-agency-id-list) for help in locating a code
   list.
