...
<img src="/Score/img/user-guide/image8.png" alt="Diagram Description automatically generated" width="556" height="102" />
...
4. The following fields can be filled in.
    ...
    2. *Release Namespace*. Select from the dropdown list a Standard Namespace. See also [Namespace Management](./01-core-component-management-tips-and-tricks.md). Release Namespace is required.
...
1. [Open the detail page of the release](#find-a-release).
...
5. Click on the DEN of a CC to open its detail page. See all [View Change History of a CC](./07-common-developer-cc-management-functions.md#view-change-history-of-a-cc).
...
2. [Find a release](#find-a-release) that is the Release Draft state that is to be canceled.
...
2. There are two ways to publish a release:
    ...
    2. If there is a need to update some release detail:
        ...
        1. [Open the detail page of the release](#find-a-release) that is in the Release Draft state.
...
1. [Open the detail page of the new release](#find-a-release).
