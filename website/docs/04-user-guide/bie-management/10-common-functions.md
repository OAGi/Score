...
1. Click the <img src="/Score/img/user-guide/image13.png" width="30" height="28" /> icon. This icon is usually located in the details
...
1. Click the <img src="/Score/img/user-guide/image13.png" width="30" height="28" /> icon.
...
2. In the window returned at the right of the page, you can see all the
   ...
   pencil button <img src="/Score/img/user-guide/image14.png" width="18" height="20" /> next to the comment.
