...
With that, we will first describe [Manage Code Lists](./02-bie-content.md) and then [Manage Context](./05-manage-context.md) before [Manage BIE](./06-manage-bie.md) where we will provide more details about fields on the different kinds of BIE nodes.
