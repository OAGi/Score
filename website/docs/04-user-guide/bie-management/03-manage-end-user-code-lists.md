...
3. A new, derived code list is created. All the code list values from
   ...
   changed according to [Edit detail of a brand-new code list value](#edit-detail-of-a-brand-new-code-list-value). They can be
...
See [Add a brand-new Agency ID List value to the Agency ID List](./04-manage-end-user-agency-id-lists.md#add-a-brand-new-agency-id-list-value-to-the-agency-id-list).

## Remove a brand-new code list value from the code list

See [Remove a brand-new Agency ID List value from the Agency ID List](./04-manage-end-user-agency-id-lists.md#remove-a-brand-new-agency-id-list-value-from-the-agency-id-list).

## Edit detail of a brand-new code list value

See [Edit detail of a brand-new Agency ID List value](./04-manage-end-user-agency-id-lists.md#edit-detail-of-a-brand-new-agency-id-list-value).
...
4. [Detail of the code list can be updated including add/change code list values.](#edit-detail-of-a-code-list-during-its-amendment)
...
1. Open the "Edit Code List" detail page according to [View detail of a code list](#view-detail-of-a-code-list). The code list has to be
   ...
   1. Only some fields can be edited according to [Edit detail of a revised Agency ID List](./04-manage-end-user-agency-id-lists.md#edit-detail-of-an-agency-id-list-during-its-amendment).
...
The detail can be edited in the same way as [Revise detail of an Agency ID List value](./04-manage-end-user-agency-id-lists.md#revise-detail-of-an-agency-id-list-value).
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   delete. Make sure you are on a published release branch. See [Find a code list](#find-a-code-list) for help in locating a code list.
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   [Find a code list](#find-a-code-list) for help in locating a code
   list.
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   Make sure you are on a published release branch. See [Find a code list](#find-a-code-list) for help in locating a code list.
...
1. Go to the "Code List" page by clicking the "View/Edit Code List" menu
   ...
   ownership. Make sure you are on a published release branch. See [Find a code list](#find-a-code-list) for help in locating a code list.
...
2. On the returned "Uplift Code List" page:
   ...
   3. Choose a source code list from the listing table below. The list
      ...
      *Name* or other filters on the page to find the desired source
      ...
      those described in [How to Search and Filter for a Core Component](../core-component-management/03-search-and-browse-cc-library.md#how-to-search-and-filter-for-a-core-component),
