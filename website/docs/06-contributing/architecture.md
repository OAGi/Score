...
| `integration_management` | GitHub-issue integration for tracking component changes. | (see [GitHub Integration](../04-user-guide/core-component-management/developer/github-integration/index.md)) |
...
| `tenant_management` | Multi-tenant configuration. | (see [Multi-Tenant Management](../04-user-guide/administration/multi-tenant-management/index.md)) |
