...
public class CoreComponentsRepository {
    ...
    static {
        FIND_STATEMENT_FOR_CURRENT_RELEASE_MAP_BY_TYPES.put("ACC",
                "SELECT 'ACC' as type, acc.acc_id AS id, acc.guid, acc.den, acc.owner_user_id, u.login_id AS owner, acc.release_id, acc.state, acc.is_deprecated, " +
        ...
        FIND_STATEMENT_FOR_CURRENT_RELEASE_MAP_BY_TYPES.put("ASCC",
                "SELECT 'ASCC' as type, ascc.ascc_id AS id, ascc.guid, ascc.den, ascc.owner_user_id, u.login_id AS owner, ascc.release_id, ascc.state, ascc.is_deprecated, " +
        ...
        FIND_STATEMENT_FOR_CURRENT_RELEASE_MAP_BY_TYPES.put("ASCCP",
                "SELECT 'ASCCP' as type, asccp.asccp_id AS id, asccp.guid, asccp.den, asccp.owner_user_id, u.login_id AS owner, asccp.release_id, asccp.state, asccp.is_deprecated, " +
        ...
        FIND_STATEMENT_FOR_CURRENT_RELEASE_MAP_BY_TYPES.put("BCC",
                "SELECT 'BCC' as type, bcc.bcc_id AS id, bcc.guid, bcc.den, bcc.owner_user_id, u.login_id AS owner, bcc.release_id, bcc.state, bcc.is_deprecated, " +
        ...
        FIND_STATEMENT_FOR_CURRENT_RELEASE_MAP_BY_TYPES.put("BCCP",
                "SELECT 'BCCP' as type, bccp.bccp_id AS id, bccp.guid, bccp.den, bccp.owner_user_id, u.login_id AS owner, bccp.release_id, bccp.state, bccp.is_deprecated, " +
    ...
    private static final String FIND_ALL_STATEMENT_FOR_CURRENT_RELEASE =
            "SELECT t.type, t.id, t.guid, t.den, t.owner_user_id, t.owner, t.release_id, t.state, t.is_deprecated, t.oagis_component_type, " +
    ...
    private static final String FIND_DELTA_STATEMENT =
            "SELECT t.type, t.id, t.guid, t.den, t.owner_user_id, t.owner, t.release_id, t.state, t.is_deprecated, " +
