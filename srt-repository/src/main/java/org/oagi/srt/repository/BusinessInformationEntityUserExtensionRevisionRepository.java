...
public interface BusinessInformationEntityUserExtensionRevisionRepository extends
    ...
    @Modifying
    @Query("delete from BusinessInformationEntityUserExtensionRevision b where b.topLevelAbie.topLevelAbieId = ?1")
    public void deleteByTopLevelAbieId(long topLevelAbieId);
}
