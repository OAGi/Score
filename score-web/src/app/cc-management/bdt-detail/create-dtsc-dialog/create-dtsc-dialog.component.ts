...
@Component({
  ...
  templateUrl: './create-dtsc-dialog.component.html',
  styleUrls: ['./create-dtsc-dialog.component.css'],
  animations: [
...
export class CreateDtscDialogComponent implements OnInit {
