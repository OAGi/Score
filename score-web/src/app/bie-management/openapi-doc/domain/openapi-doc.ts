...
// operationId + resource-path naming (issue #1732) is the single source of truth in
// oas-operation-validation.ts (buildOperationId / recomputeOperationId / operationName /
// resourcePathLeaf / buildResourcePath / applyResourceArrayMarker) so the rule can never drift
// between the two OpenAPI editors and the two Add dialogs. Import them from there, not here.
