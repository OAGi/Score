...
public class P_1_5_1_to_2_PopulateBDTsInDTTestCase extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    static {
        ...
        List<ExpectedDataType> defaultBDTs = Arrays.asList(
                ...
                new ExpectedDataType("oagis-id-c62bf0f41c964349b874b8f397f673ec", "Indicator_CVW231. Type", 0, "Indicator. Type", "An indicator is a list of two mutually exclusive Boolean values that express the only possible states of a property", "xbt_BooleanTrueFalseType"),
