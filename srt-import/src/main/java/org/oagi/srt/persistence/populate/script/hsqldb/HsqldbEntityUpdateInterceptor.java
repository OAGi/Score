...
import static org.oagi.srt.persistence.populate.script.hsqldb.HsqldbDataImportScriptPrinter.print;

public class HsqldbEntityUpdateInterceptor extends EmptyInterceptor {
    ...
    private String valueSet(
        ...
        if (type == BooleanType.INSTANCE) {
            ...
            sb.append("'").append(toHex((byte[]) value)).append("'");
