...
import static org.oagi.srt.persistence.populate.script.postgres.PostgresDataImportScriptPrinter.*;

@Component
@Lazy
public class PostgresDataImportScriptRunner implements DataImportScriptRunner {
