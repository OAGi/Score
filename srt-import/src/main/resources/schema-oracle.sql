...
ALTER TABLE BBIE ADD CONSTRAINT BBIE_AGENCY_ID_LIST_FK FOREIGN KEY ( AGENCY_ID_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) NOT DEFERRABLE ;
