...
IS
  ...
  CREATE INDEX ACC_GUID_IDX ON ACC
    ( GUID ASC
    ) LOGGING ;
...
The value of this column for the current record should be left NULL.' ;
  CREATE INDEX ASCC_GUID_IDX ON ASCC
    ( GUID ASC
    ) LOGGING ;
...
IS
  ...
  CREATE INDEX ASCCP_GUID_IDX ON ASCCP
    ( GUID ASC
    ) LOGGING ;
...
IS
  ...
  CREATE INDEX BCC_GUID_IDX ON BCC
    ( GUID ASC
    ) LOGGING ;
...
IS
  'This column specifies the default value constraint. Default and fixed value constraints cannot be used at the same time.' ;
  CREATE INDEX BCCP_GUID_IDX ON BCCP
    ( GUID ASC
    ) LOGGING ;
...
CREATE TABLE XBT
  (
    ...
    JBT_DRAFT05_MAP   VARCHAR2 (500 CHAR) ,
