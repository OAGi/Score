...
DROP TABLE BIE_USAGE_RULE CASCADE CONSTRAINTS ;
...
DROP TABLE DT_USAGE_RULE CASCADE CONSTRAINTS ;
...
DROP TABLE USAGE_RULE CASCADE CONSTRAINTS ;

DROP TABLE USAGE_RULE_EXPRESSION CASCADE CONSTRAINTS ;
...
CREATE TABLE APP_USER
  (
    ...
    OAGIS_DEVELOPER_INDICATOR NUMBER NOT NULL
  ) ;
...
CREATE TABLE BIE_USAGE_RULE
  (
    BIE_USAGE_RULE_ID      NUMBER (19) NOT NULL ,
    ASSIGNED_USAGE_RULE_ID NUMBER (19) NOT NULL ,
    TARGET_ABIE_ID         NUMBER (19) ,
    TARGET_ASBIE_ID        NUMBER (19) ,
    TARGET_ASBIEP_ID       NUMBER (19) ,
    TARGET_BBIE_ID         NUMBER (19) ,
    TARGET_BBIEP_ID        NUMBER (19)
  ) ;
...
CREATE TABLE BIE_USER_EXT_REVISION
  (
    ...
    REVISED_INDICATOR        NUMBER NOT NULL
  ) ;
...
CREATE TABLE CODE_LIST
  (
    ...
    EXTENSIBLE_INDICATOR  NUMBER NOT NULL ,
    MODULE_ID             NUMBER (19) ,
    CREATED_BY            NUMBER (19) NOT NULL ,
    LAST_UPDATED_BY       NUMBER (19) NOT NULL ,
    CREATION_TIMESTAMP    TIMESTAMP WITH TIME ZONE NOT NULL ,
...
CREATE TABLE CODE_LIST_VALUE
  (
    ...
    NAME                VARCHAR2 (100 CHAR) ,
    USED_INDICATOR      NUMBER NOT NULL ,
    LOCKED_INDICATOR    NUMBER NOT NULL ,
    EXTENSION_INDICATOR NUMBER NOT NULL
  ) ;
...
CREATE TABLE DEFINITION
  (
    ...
    REF_TABLE_NAME  VARCHAR2 (30 CHAR) NOT NULL ,
    REF_COLUMN_NAME VARCHAR2 (30) NOT NULL ,
    SEQ             NUMBER (10) NOT NULL ,
    LANGUAGE_CODE   VARCHAR2 (20 CHAR) NOT NULL ,
    GUID            VARCHAR2 (36 CHAR) NOT NULL ,
    DEFINITION CLOB ,
    DEFINITION_SOURCE VARCHAR2 (200 CHAR) ,
    CONTENT_TYPE      VARCHAR2 (100 CHAR)
  ) ;
COMMENT ON COLUMN DEFINITION.REF_ID
IS
  'The reference ID which points to this definition ID.' ;
  COMMENT ON COLUMN DEFINITION.REF_TABLE_NAME
IS
  'The reference table name which points to this definition ID.' ;
  COMMENT ON COLUMN DEFINITION.REF_COLUMN_NAME
IS
  'The reference column name which points to this definition ID. The default value is ''DEFINITION''.' ;
  COMMENT ON COLUMN DEFINITION.SEQ
IS
  'Non-negative number of the definitions. The default value is 1.' ;
  COMMENT ON COLUMN DEFINITION.LANGUAGE_CODE
IS
  'The language code about the clob content. If this value is empty, it should be dealt with ''en'', English.' ;
  COMMENT ON COLUMN DEFINITION.GUID
IS
  'A surrogate column of definition table. It is created by UUIDv3 (REF_ID, REF_TABLE_NAME, REF_COLUMN_NAME).' ;
  COMMENT ON COLUMN DEFINITION.CONTENT_TYPE
IS
  'The type of the definition content. If this value is empty, it should be dealt with ''text/plain''.' ;
  CREATE INDEX DEFINITION_UK1 ON DEFINITION
    (
      REF_ID ASC ,
      REF_TABLE_NAME ASC ,
      REF_COLUMN_NAME ASC ,
...
ALTER TABLE DEFINITION ADD CONSTRAINT DEFINITION_PK PRIMARY KEY ( REF_ID, REF_TABLE_NAME, REF_COLUMN_NAME, SEQ, LANGUAGE_CODE ) ;
...
CREATE TABLE DT_USAGE_RULE
  (
    DT_USAGE_RULE_ID       NUMBER (19) NOT NULL ,
    ASSIGNED_USAGE_RULE_ID NUMBER (19) NOT NULL ,
    TARGET_DT_ID           NUMBER (19) ,
    TARGET_DT_SC_ID        NUMBER (19)
  ) ;
...
CREATE TABLE USAGE_RULE
  (
    USAGE_RULE_ID  NUMBER (19) NOT NULL ,
    NAME           VARCHAR2 (4000) ,
    CONDITION_TYPE NUMBER (5) NOT NULL
  ) ;
...
CREATE TABLE USAGE_RULE_EXPRESSION
  (
    USAGE_RULE_EXPRESSION_ID NUMBER (19) NOT NULL ,
    CONSTRAINT_TYPE          NUMBER (5) NOT NULL ,
    CONSTRAINT_TEXT CLOB NOT NULL ,
    REPRESENTED_USAGE_RULE_ID NUMBER (19) NOT NULL
  ) ;
...
ALTER TABLE ABIE ADD CONSTRAINT ABIE_BASED_ACC_ID_FK FOREIGN KEY ( BASED_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE ABIE ADD CONSTRAINT ABIE_BIZ_CTX_ID_FK FOREIGN KEY ( BIZ_CTX_ID ) REFERENCES BIZ_CTX ( BIZ_CTX_ID ) ;

ALTER TABLE ABIE ADD CONSTRAINT ABIE_CLIENT_ID_FK FOREIGN KEY ( CLIENT_ID ) REFERENCES CLIENT ( CLIENT_ID ) ;

ALTER TABLE ABIE ADD CONSTRAINT ABIE_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ABIE ADD CONSTRAINT ABIE_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ABIE ADD CONSTRAINT ABIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_BASED_ACC_ID_FK FOREIGN KEY ( BASED_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_CURRENT_ACC_ID_FK FOREIGN KEY ( CURRENT_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_NAMESPACE_ID_FK FOREIGN KEY ( NAMESPACE_ID ) REFERENCES NAMESPACE ( NAMESPACE_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ACC ADD CONSTRAINT ACC_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE AGENCY_ID_LIST ADD CONSTRAINT AGENCY_ID_LIST_AILV_FK FOREIGN KEY ( AGENCY_ID_LIST_VALUE_ID ) REFERENCES AGENCY_ID_LIST_VALUE ( AGENCY_ID_LIST_VALUE_ID ) ;

ALTER TABLE AGENCY_ID_LIST ADD CONSTRAINT AGENCY_ID_LIST_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE AGENCY_ID_LIST_VALUE ADD CONSTRAINT AILV_AGENCY_ID_LIST_FK FOREIGN KEY ( OWNER_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) ;

ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_BASED_ASCCP_ID_FK FOREIGN KEY ( BASED_ASCCP_ID ) REFERENCES ASCCP ( ASCCP_ID ) ;

ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_ROLE_OF_ABIE_ID FOREIGN KEY ( ROLE_OF_ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_BASED_ASCC_ID_FK FOREIGN KEY ( BASED_ASCC_ID ) REFERENCES ASCC ( ASCC_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_FROM_ABIE_ID FOREIGN KEY ( FROM_ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_TO_ASBIEP_ID_FK FOREIGN KEY ( TO_ASBIEP_ID ) REFERENCES ASBIEP ( ASBIEP_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_CURRENT_ASCCP_ID_FK FOREIGN KEY ( CURRENT_ASCCP_ID ) REFERENCES ASCCP ( ASCCP_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_NAMESPACE_ID_FK FOREIGN KEY ( NAMESPACE_ID ) REFERENCES NAMESPACE ( NAMESPACE_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_ROLE_OF_ACC_ID_FK FOREIGN KEY ( ROLE_OF_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_CURRENT_ASCC_ID_FK FOREIGN KEY ( CURRENT_ASCC_ID ) REFERENCES ASCC ( ASCC_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_FROM_ACC_ID_FK FOREIGN KEY ( FROM_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE ASCC ADD CONSTRAINT ASCC_TO_ASCCP_ID_FK FOREIGN KEY ( TO_ASCCP_ID ) REFERENCES ASCCP ( ASCCP_ID ) ;

ALTER TABLE BBIEP ADD CONSTRAINT BBIEP_BASED_BCCP_ID_FK FOREIGN KEY ( BASED_BCCP_ID ) REFERENCES BCCP ( BCCP_ID ) ;

ALTER TABLE BBIEP ADD CONSTRAINT BBIEP_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BBIEP ADD CONSTRAINT BBIEP_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BBIEP ADD CONSTRAINT BBIEP_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_AGENCY_ID_LIST_ID_FK FOREIGN KEY ( AGENCY_ID_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_BASED_BCC_ID_FK FOREIGN KEY ( BASED_BCC_ID ) REFERENCES BCC ( BCC_ID ) ;
...
ALTER TABLE BBIE ADD CONSTRAINT BBIE_CODE_LIST_ID_FK FOREIGN KEY ( CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_FROM_ABIE_ID_FK FOREIGN KEY ( FROM_ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_AGENCY_ID_LIST_ID_FK FOREIGN KEY ( AGENCY_ID_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) ;

ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_BBIE_ID_FK FOREIGN KEY ( BBIE_ID ) REFERENCES BBIE ( BBIE_ID ) ;

ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_CODE_LIST_ID_FK FOREIGN KEY ( CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_DT_SC_ID_FK FOREIGN KEY ( DT_SC_ID ) REFERENCES DT_SC ( DT_SC_ID ) ;
...
ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( OWNER_TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE BBIE ADD CONSTRAINT BBIE_TO_BBIEP_ID_FK FOREIGN KEY ( TO_BBIEP_ID ) REFERENCES BBIEP ( BBIEP_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_BDT_ID_FK FOREIGN KEY ( BDT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_CURRENT_BCCP_ID_FK FOREIGN KEY ( CURRENT_BCCP_ID ) REFERENCES BCCP ( BCCP_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_NAMESPACE_ID_FK FOREIGN KEY ( NAMESPACE_ID ) REFERENCES NAMESPACE ( NAMESPACE_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCCP ADD CONSTRAINT BCCP_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_CURRENT_BCC_ID_FK FOREIGN KEY ( CURRENT_BCC_ID ) REFERENCES BCC ( BCC_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_FROM_ACC_ID_FK FOREIGN KEY ( FROM_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE BCC ADD CONSTRAINT BCC_TO_BCCP_ID_FK FOREIGN KEY ( TO_BCCP_ID ) REFERENCES BCCP ( BCCP_ID ) ;

ALTER TABLE BIZ_CTX ADD CONSTRAINT BIZ_CTX_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE BIZ_CTX ADD CONSTRAINT BIZ_CTX_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;
...
ALTER TABLE BIZ_CTX_VALUE ADD CONSTRAINT BIZ_CTX_VALUE_CSV_ID_FK FOREIGN KEY ( CTX_SCHEME_VALUE_ID ) REFERENCES CTX_SCHEME_VALUE ( CTX_SCHEME_VALUE_ID ) ;

ALTER TABLE BLOB_CONTENT ADD CONSTRAINT BLOB_CONTENT_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE BLOB_CONTENT ADD CONSTRAINT BLOB_CONTENT_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE BDT_PRI_RESTRI ADD CONSTRAINT BPR_AGENCY_ID_LIST_ID_FK FOREIGN KEY ( AGENCY_ID_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) ;

ALTER TABLE BDT_PRI_RESTRI ADD CONSTRAINT BPR_BDT_ID_FK FOREIGN KEY ( BDT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE BDT_PRI_RESTRI ADD CONSTRAINT BPR_CAPXTM_ID_FK FOREIGN KEY ( CDT_AWD_PRI_XPS_TYPE_MAP_ID ) REFERENCES CDT_AWD_PRI_XPS_TYPE_MAP ( CDT_AWD_PRI_XPS_TYPE_MAP_ID ) ;

ALTER TABLE BDT_PRI_RESTRI ADD CONSTRAINT BPR_CODE_LIST_ID_FK FOREIGN KEY ( CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE BDT_SC_PRI_RESTRI ADD CONSTRAINT BSPR_AGENCY_ID_LIST_ID_FK FOREIGN KEY ( AGENCY_ID_LIST_ID ) REFERENCES AGENCY_ID_LIST ( AGENCY_ID_LIST_ID ) ;

ALTER TABLE BDT_SC_PRI_RESTRI ADD CONSTRAINT BSPR_BDT_SC_ID_FK FOREIGN KEY ( BDT_SC_ID ) REFERENCES DT_SC ( DT_SC_ID ) ;

ALTER TABLE BDT_SC_PRI_RESTRI ADD CONSTRAINT BSPR_CODE_LIST_ID_FK FOREIGN KEY ( CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE BDT_SC_PRI_RESTRI ADD CONSTRAINT BSPR_CSAPXTM_ID_FK FOREIGN KEY ( CDT_SC_AWD_PRI_XPS_TYPE_MAP_ID ) REFERENCES CDT_SC_AWD_PRI_XPS_TYPE_MAP ( CDT_SC_AWD_PRI_XPS_TYPE_MAP_ID ) ;

ALTER TABLE BIE_USER_EXT_REVISION ADD CONSTRAINT BUER_EXT_ABIE_ID_FK FOREIGN KEY ( EXT_ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE BIE_USER_EXT_REVISION ADD CONSTRAINT BUER_EXT_ACC_ID_FK FOREIGN KEY ( EXT_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE BIE_USER_EXT_REVISION ADD CONSTRAINT BUER_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY ( TOP_LEVEL_ABIE_ID ) REFERENCES TOP_LEVEL_ABIE ( TOP_LEVEL_ABIE_ID ) ;

ALTER TABLE BIE_USER_EXT_REVISION ADD CONSTRAINT BUER_USER_EXT_ACC_ID_FK FOREIGN KEY ( USER_EXT_ACC_ID ) REFERENCES ACC ( ACC_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_ABIE_ID_FK FOREIGN KEY ( TARGET_ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_ASBIEP_ID_FK FOREIGN KEY ( TARGET_ASBIEP_ID ) REFERENCES ASBIEP ( ASBIEP_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_ASBIE_ID_FK FOREIGN KEY ( TARGET_ASBIE_ID ) REFERENCES ASBIE ( ASBIE_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_BBIEP_ID_FK FOREIGN KEY ( TARGET_BBIEP_ID ) REFERENCES BBIEP ( BBIEP_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_BBIE_ID_FK FOREIGN KEY ( TARGET_BBIE_ID ) REFERENCES BBIE ( BBIE_ID ) ;

ALTER TABLE BIE_USAGE_RULE ADD CONSTRAINT BUR_USAGE_RULE_ID_FK FOREIGN KEY ( ASSIGNED_USAGE_RULE_ID ) REFERENCES USAGE_RULE ( USAGE_RULE_ID ) ;

ALTER TABLE CDT_AWD_PRI_XPS_TYPE_MAP ADD CONSTRAINT CAPXTM_CDT_AWD_PRI_ID_FK FOREIGN KEY ( CDT_AWD_PRI_ID ) REFERENCES CDT_AWD_PRI ( CDT_AWD_PRI_ID ) ;

ALTER TABLE CDT_AWD_PRI_XPS_TYPE_MAP ADD CONSTRAINT CAPXTM_XBT_ID_FK FOREIGN KEY ( XBT_ID ) REFERENCES XBT ( XBT_ID ) ;

ALTER TABLE CDT_AWD_PRI ADD CONSTRAINT CDT_AWD_PRI_CDT_ID_FK FOREIGN KEY ( CDT_ID ) REFERENCES DT ( DT_ID ) ;
...
ALTER TABLE CDT_SC_AWD_PRI ADD CONSTRAINT CDT_SC_AWD_PRI_CDT_SC_ID_FK FOREIGN KEY ( CDT_SC_ID ) REFERENCES DT_SC ( DT_SC_ID ) ;

ALTER TABLE CODE_LIST_VALUE ADD CONSTRAINT CLV_CODE_LIST_ID_FK FOREIGN KEY ( CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE CODE_LIST ADD CONSTRAINT CODE_LIST_AILV_FK FOREIGN KEY ( AGENCY_ID ) REFERENCES AGENCY_ID_LIST_VALUE ( AGENCY_ID_LIST_VALUE_ID ) ;

ALTER TABLE CODE_LIST ADD CONSTRAINT CODE_LIST_BASED_CL_ID_FK FOREIGN KEY ( BASED_CODE_LIST_ID ) REFERENCES CODE_LIST ( CODE_LIST_ID ) ;

ALTER TABLE CODE_LIST ADD CONSTRAINT CODE_LIST_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE CODE_LIST ADD CONSTRAINT CODE_LIST_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE CODE_LIST ADD CONSTRAINT CODE_LIST_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE CDT_SC_AWD_PRI_XPS_TYPE_MAP ADD CONSTRAINT CSAPXTM_CSAP_FK FOREIGN KEY ( CDT_SC_AWD_PRI_ID ) REFERENCES CDT_SC_AWD_PRI ( CDT_SC_AWD_PRI_ID ) ;

ALTER TABLE CDT_SC_AWD_PRI_XPS_TYPE_MAP ADD CONSTRAINT CSAPXTM_XBT_ID_FK FOREIGN KEY ( XBT_ID ) REFERENCES XBT ( XBT_ID ) ;

ALTER TABLE CTX_SCHEME_VALUE ADD CONSTRAINT CSV_OWNER_CTX_SCHEME_ID_FK FOREIGN KEY ( OWNER_CTX_SCHEME_ID ) REFERENCES CTX_SCHEME ( CTX_SCHEME_ID ) ;

ALTER TABLE CTX_SCHEME ADD CONSTRAINT CTX_SCHEME_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE CTX_SCHEME ADD CONSTRAINT CTX_SCHEME_CTX_CAT_ID_FK FOREIGN KEY ( CTX_CATEGORY_ID ) REFERENCES CTX_CATEGORY ( CTX_CATEGORY_ID ) ;

ALTER TABLE CTX_SCHEME ADD CONSTRAINT CTX_SCHEME_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_BASED_DT_ID_FK FOREIGN KEY ( BASED_DT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_CURRENT_BDT_ID_FK FOREIGN KEY ( CURRENT_BDT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_MODULE_ID_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_PREVIOUS_VERSION_DT_ID_FK FOREIGN KEY ( PREVIOUS_VERSION_DT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE DT ADD CONSTRAINT DT_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE DT_SC ADD CONSTRAINT DT_SC_BASED_DT_SC_ID_FK FOREIGN KEY ( BASED_DT_SC_ID ) REFERENCES DT_SC ( DT_SC_ID ) ;

ALTER TABLE DT_SC ADD CONSTRAINT DT_SC_OWNER_DT_ID_FK FOREIGN KEY ( OWNER_DT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE DT_USAGE_RULE ADD CONSTRAINT DT_USAGE_RULE_DT_ID_FK FOREIGN KEY ( TARGET_DT_ID ) REFERENCES DT ( DT_ID ) ;

ALTER TABLE DT_USAGE_RULE ADD CONSTRAINT DT_USAGE_RULE_DT_SC_ID_FK FOREIGN KEY ( TARGET_DT_SC_ID ) REFERENCES DT_SC ( DT_SC_ID ) ;

ALTER TABLE DT_USAGE_RULE ADD CONSTRAINT DT_USAGE_RULE_USAGE_RULE_ID_FK FOREIGN KEY ( ASSIGNED_USAGE_RULE_ID ) REFERENCES USAGE_RULE ( USAGE_RULE_ID ) ;

ALTER TABLE MODULE_DEP ADD CONSTRAINT MODULE_DEPENDED_ID_FK FOREIGN KEY ( DEPENDED_MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE MODULE_DEP ADD CONSTRAINT MODULE_DEPENDING_ID_FK FOREIGN KEY ( DEPENDING_MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE MODULE ADD CONSTRAINT MODULE_NAMESPACE_ID_FK FOREIGN KEY ( NAMESPACE_ID ) REFERENCES NAMESPACE ( NAMESPACE_ID ) ;

ALTER TABLE MODULE ADD CONSTRAINT MODULE_RELEASE_ID_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;

ALTER TABLE NAMESPACE ADD CONSTRAINT NAMESPACE_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE NAMESPACE ADD CONSTRAINT NAMESPACE_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE NAMESPACE ADD CONSTRAINT NAMESPACE_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE RELEASE ADD CONSTRAINT RELEASE_NAMESPACE_ID_FK FOREIGN KEY ( NAMESPACE_ID ) REFERENCES NAMESPACE ( NAMESPACE_ID ) ;

ALTER TABLE TOP_LEVEL_ABIE ADD CONSTRAINT TOP_LEVEL_ABIE_ABIE_ID_FK FOREIGN KEY ( ABIE_ID ) REFERENCES ABIE ( ABIE_ID ) ;

ALTER TABLE TOP_LEVEL_ABIE ADD CONSTRAINT TOP_LEVEL_ABIE_APP_USER_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE USAGE_RULE_EXPRESSION ADD CONSTRAINT USAGE_RULE_XPS_REPS_UR_ID_FK FOREIGN KEY ( REPRESENTED_USAGE_RULE_ID ) REFERENCES USAGE_RULE ( USAGE_RULE_ID ) ;

ALTER TABLE XBT ADD CONSTRAINT XBT_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE XBT ADD CONSTRAINT XBT_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE XBT ADD CONSTRAINT XBT_MODULE_FK FOREIGN KEY ( MODULE_ID ) REFERENCES MODULE ( MODULE_ID ) ;

ALTER TABLE XBT ADD CONSTRAINT XBT_OWNER_USER_ID_FK FOREIGN KEY ( OWNER_USER_ID ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE XBT ADD CONSTRAINT XBT_RELEASE_FK FOREIGN KEY ( RELEASE_ID ) REFERENCES RELEASE ( RELEASE_ID ) ;
