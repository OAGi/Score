...
ALTER TABLE TOP_LEVEL_ABIE
  DROP CONSTRAINT TOP_LEVEL_ABIE_ABIE_ID_FK;
DROP TABLE ABIE;
...
CREATE UNIQUE INDEX APP_USER_UK1
  ON APP_USER (LOGIN_ID ASC);
...
CREATE UNIQUE INDEX XBT_UK1
  ON XBT (NAME ASC);
CREATE UNIQUE INDEX XBT_UK2
  ON XBT (BUILTIN_TYPE ASC);
...
CREATE UNIQUE INDEX CDT_PRI_UK1
  ON CDT_PRI (NAME ASC);
...
CREATE UNIQUE INDEX BCCP_UK1
  ON BCCP (GUID);
CREATE UNIQUE INDEX BCCP_UK2
  ON BCCP (PROPERTY_TERM, BDT_ID);
...
CREATE UNIQUE INDEX BCC_UK1
  ON BCC (GUID, FROM_ACC_ID, TO_BCCP_ID);
...
CREATE UNIQUE INDEX BIZ_CTX_UK1
  ON BIZ_CTX (GUID);
...
CREATE TABLE TOP_LEVEL_ABIE (
  ...
  ABIE_ID           NUMBER(10) NULL,

  CONSTRAINT TOP_LEVEL_ABIE_PK PRIMARY KEY (TOP_LEVEL_ABIE_ID)
);

CREATE SEQUENCE TOP_LEVEL_ABIE_ID_SEQ
MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 NOCYCLE;
...
CREATE TABLE ABIE (
  ...
  OWNER_TOP_LEVEL_ABIE_ID NUMBER(10)    NOT NULL,
  ...
  CONSTRAINT ABIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);
...
CREATE TABLE BBIEP (
  ...
  CONSTRAINT BBIEP_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);

CREATE UNIQUE INDEX BBIEP_UK1
  ON BBIEP (GUID);
...
CREATE UNIQUE INDEX AGENCY_ID_LIST_UK1
  ON AGENCY_ID_LIST (GUID);
CREATE UNIQUE INDEX AGENCY_ID_LIST_UK2
  ON AGENCY_ID_LIST (ENUM_TYPE_GUID ASC);
...
CREATE UNIQUE INDEX CODE_LIST_UK1
  ON CODE_LIST (GUID);
CREATE UNIQUE INDEX CODE_LIST_UK2
  ON CODE_LIST (ENUM_TYPE_GUID ASC);
...
CREATE TABLE BBIE (
  ...
  CONSTRAINT BBIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);

CREATE UNIQUE INDEX BBIE_UK1
  ON BBIE (GUID, FROM_ABIE_ID, TO_BBIEP_ID);
...
CREATE TABLE ASBIEP (
  ...
  CONSTRAINT ASBIEP_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);

CREATE UNIQUE INDEX ASBIEP_UK1
  ON ASBIEP (GUID);
...
CREATE UNIQUE INDEX ASCC_UK1
  ON ASCC (GUID, FROM_ACC_ID, TO_ASCCP_ID);
...
CREATE TABLE ASBIE (
  ...
  CONSTRAINT ASBIE_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);

CREATE UNIQUE INDEX ASBIE_UK1
  ON ASBIE (GUID, FROM_ABIE_ID, TO_ASBIEP_ID);
...
CREATE UNIQUE INDEX CTX_CATEGORY_UK1
  ON CTX_CATEGORY (GUID);
...
CREATE UNIQUE INDEX CTX_SCHEME_UK1
  ON CLASSIFICATION_CTX_SCHEME (GUID);
...
CREATE UNIQUE INDEX CTX_SCHEME_VALUE_UK1
  ON CTX_SCHEME_VALUE (GUID);
...
CREATE TABLE BBIE_SC (
  ...
  CONSTRAINT BBIE_SC_TOP_LEVEL_ABIE_ID_FK FOREIGN KEY (OWNER_TOP_LEVEL_ABIE_ID) REFERENCES TOP_LEVEL_ABIE (TOP_LEVEL_ABIE_ID)
);
