...
IS
  'A foreign key referring to the user who creates the ABIE. The creator of the ABIE is also its ownerName by default. ABIEs created as children of another ABIE have the same CREATED_BY as its parent.' ;
...
IS
  '2 = EDITING, 4 = PUBLISHED. This column is only used with a top-level ABIE, because that is the only entry point for editing. The state value indicates the visibility of the top-level ABIE to users other than the ownerName. In the user group environment, a logic can apply that other users in the group can see the top-level ABIE only when it is in the ''Published'' state.' ;
...
IS
  'A foreign key referring to the user who creates the ASBIE. The creator of the ASBIE is also its ownerName by default. ASBIEs created as children of another ABIE have the same CREATED_BY.' ;
...
IS
  'A foreign key referring to the user who creates the ASBIEP. The creator of the ASBIEP is also its ownerName by default. ASBIEPs created as children of another ABIE have the same CREATED_BY_USER_ID.' ;
...
IS
  'A foreign key referring to the user who creates the BBIE. The creator of the BBIE is also its ownerName by default. BBIEs created as children of another ABIE have the same CREATED_BY.' ;
...
IS
  'A foreign key referring to the user who creates the BBIEP. The creator of the BBIEP is also its ownerName by default. BBIEPs created as children of another ABIE have the same CREATED_BY'',' ;
...
IS
  ...
  COMMENT ON COLUMN TOP_LEVEL_ABIE.OWNER
IS
  'A foreign key referring to the user who creates the TOP_LEVEL_ABIE.' ;
  COMMENT ON COLUMN TOP_LEVEL_ABIE.STATE
IS
  '2 = EDITING, 4 = PUBLISHED.' ;
CREATE UNIQUE INDEX TOP_LEVEL_ABIE_PK_IDX ON TOP_LEVEL_ABIE
  ...
  CREATE INDEX TOP_LEVEL_ABIE_OWNER_IDX ON TOP_LEVEL_ABIE
    ( OWNER ASC
    ) ;
...
ALTER TABLE TOP_LEVEL_ABIE ADD CONSTRAINT TOP_LEVEL_ABIE_APP_USER_FK FOREIGN KEY ( OWNER ) REFERENCES APP_USER ( APP_USER_ID ) NOT DEFERRABLE ;
