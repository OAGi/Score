...
DROP VIEW V_PROFILE_BOD 
;

DROP VIEW V_TOP_LEVEL_CONCEPT 
;
...
CREATE SEQUENCE ABIE_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;
...
CREATE SEQUENCE ASBIEP_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;

CREATE SEQUENCE ASBIE_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;
...
CREATE SEQUENCE BBIEP_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;

CREATE SEQUENCE BBIE_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;

CREATE SEQUENCE BBIE_SC_ID_SEQ START WITH 1 INCREMENT BY 1000 MAXVALUE 999999999999999999999999 MINVALUE 1 ;
...
CREATE OR REPLACE VIEW V_PROFILE_BOD  AS
SELECT TOP_LEVEL_ABIE.TOP_LEVEL_ABIE_ID,
  ABIE.ABIE_ID,
  ASBIEP.ASBIEP_ID,
  ASCCP.ASCCP_ID,
  ASCCP.PROPERTY_TERM,
  ...
  ABIE.STATE,
  ABIE.CREATED_BY,
  APP_USER.NAME AS CREATED_USERNAME,
  ABIE.CREATION_TIMESTAMP
FROM TOP_LEVEL_ABIE
INNER JOIN ABIE
ON ABIE.ABIE_ID                      = TOP_LEVEL_ABIE.ABIE_ID
AND TOP_LEVEL_ABIE.TOP_LEVEL_ABIE_ID = ABIE.OWNER_TOP_LEVEL_ABIE_ID
INNER JOIN BIZ_CTX
ON BIZ_CTX.BIZ_CTX_ID = ABIE.BIZ_CTX_ID
INNER JOIN ASBIEP
ON TOP_LEVEL_ABIE.TOP_LEVEL_ABIE_ID = ASBIEP.OWNER_TOP_LEVEL_ABIE_ID
AND ABIE.ABIE_ID                    = ASBIEP.ROLE_OF_ABIE_ID
INNER JOIN ASCCP
ON ASCCP.ASCCP_ID = ASBIEP.BASED_ASCCP_ID
INNER JOIN APP_USER
ON APP_USER.APP_USER_ID  = ABIE.CREATED_BY
AND APP_USER.APP_USER_ID = ABIE.LAST_UPDATED_BY
AND APP_USER.APP_USER_ID = BIZ_CTX.CREATED_BY
AND APP_USER.APP_USER_ID = BIZ_CTX.LAST_UPDATED_BY
AND APP_USER.APP_USER_ID = ASBIEP.CREATED_BY
AND APP_USER.APP_USER_ID = ASBIEP.LAST_UPDATED_BY
AND APP_USER.APP_USER_ID = ASCCP.CREATED_BY
AND APP_USER.APP_USER_ID = ASCCP.LAST_UPDATED_BY
AND APP_USER.APP_USER_ID = ASCCP.OWNER_USER_ID 
;
...
CREATE OR REPLACE VIEW V_TOP_LEVEL_CONCEPT  AS
SELECT ASCCP.ASCCP_ID,
  ASCCP.PROPERTY_TERM,
  MODULE.MODULE,
  ASCCP.LAST_UPDATE_TIMESTAMP
FROM ASCCP
INNER JOIN MODULE
ON MODULE.MODULE_ID = ASCCP.MODULE_ID
WHERE MODULE.MODULE NOT LIKE '%Components%'
