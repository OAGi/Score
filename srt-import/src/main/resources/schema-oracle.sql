...
DROP SEQUENCE DEFINITION_ID_SEQ ;
...
CREATE SEQUENCE DEFINITION_ID_SEQ START WITH 1 INCREMENT BY 1 MAXVALUE 999999999999999999999999 MINVALUE 1 ;
...
IS
  ...
  COMMENT ON COLUMN ABIE.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ABIE_ABIE_ID_IDX ON ABIE
  ...
  CREATE INDEX ABIE_DEFINITION_ID_IDX ON ABIE
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN ACC.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ACC_ACC_ID_IDX ON ACC
  ...
  CREATE INDEX ACC_DEFINITION_ID_IDX ON ACC
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN ASBIE.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ASBIE_ASBIE_ID_IDX ON ASBIE
  ...
  CREATE INDEX ASBIE_DEFINITION_ID_IDX ON ASBIE
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN ASBIEP.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ASBIEP_ASBIEP_ID_IDX ON ASBIEP
  ...
  CREATE INDEX ASBIEP_DEFINITION_ID_IDX ON ASBIEP
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN ASCC.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ASCC_ASCC_ID_IDX ON ASCC
  ...
  CREATE INDEX ASCC_DEFINITION_ID_IDX ON ASCC
    ( DEFINITION_ID ASC
    ) ;
...
There must be only one ASCCP without a PROPERTY_TERM for a particular ACC.' ;
  COMMENT ON COLUMN ASCCP.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX ASCCP_ASCCP_ID_IDX ON ASCCP
  ...
  CREATE INDEX ASCCP_DEFINITION_ID_IDX ON ASCCP
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN BBIE.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX BBIE_BBIE_ID_IDX ON BBIE
  ...
  CREATE INDEX BBIE_DEFINITION_ID_IDX ON BBIE
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN BBIEP.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX BBIEP_BBIEP_ID_IDX ON BBIEP
  ...
  CREATE INDEX BBIEP_DEFINITION_ID_IDX ON BBIEP
    ( DEFINITION_ID ASC
    ) ;
...
IS
  'This column captures the fixed value constraint. Default and fixed value constraints cannot be used at the same time.' ;
  COMMENT ON COLUMN BBIE_SC.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX BBIE_SC_BBIE_SC_ID_IDX ON BBIE_SC
  ...
  CREATE INDEX BBIE_SC_DEFINITION_ID_IDX ON BBIE_SC
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN BCC.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX BCC_BCC_ID_IDX ON BCC
  ...
  CREATE INDEX BCC_DEFINITION_ID_IDX ON BCC
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN BCCP.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX BCCP_BCCP_ID_IDX ON BCCP
  ...
  CREATE INDEX BCCP_DEFINITION_ID_IDX ON BCCP
    ( DEFINITION_ID ASC
    ) ;
...
CREATE TABLE DEFINITION
  (
    ...
    DEFINITION CLOB ,
    DEFINITION_SOURCE VARCHAR2 (200) ,
    REF_ID            NUMBER (19) NOT NULL ,
    REF_TABLE_NAME    VARCHAR2 (50 CHAR) NOT NULL ,
    LANGUAGE_CODE     VARCHAR2 (20 CHAR) NOT NULL
  )
  LOGGING ;
CREATE UNIQUE INDEX DEFINITION_DEFINITION_ID_IDX ON DEFINITION
  (
    DEFINITION_ID ASC
  )
  ;
ALTER TABLE DEFINITION ADD CONSTRAINT DEFINITION_PK PRIMARY KEY ( DEFINITION_ID ) ;
ALTER TABLE DEFINITION ADD CONSTRAINT DEFINITION_UK1 UNIQUE ( REF_ID , REF_TABLE_NAME , LANGUAGE_CODE ) ;
...
IS
  ...
  COMMENT ON COLUMN DT.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX DT_DT_ID_IDX ON DT
  ...
  CREATE INDEX DT_DEFINITION_ID_IDX ON DT
    ( DEFINITION_ID ASC
    ) ;
...
IS
  ...
  COMMENT ON COLUMN DT_SC.DEFINITION_ID
IS
...
CREATE UNIQUE INDEX DT_SC_DT_SC_ID_IDX ON DT_SC
  ...
  CREATE INDEX DT_SC_DEFINITION_ID_IDX ON DT_SC
    ( DEFINITION_ID ASC
    ) ;
...
ALTER TABLE ABIE ADD CONSTRAINT ABIE_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE ACC ADD CONSTRAINT ACC_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE ASBIEP ADD CONSTRAINT ASBIEP_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE ASBIE ADD CONSTRAINT ASBIE_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE ASCCP ADD CONSTRAINT ASCCP_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE ASCC ADD CONSTRAINT ASCC_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE BBIEP ADD CONSTRAINT BBIEP_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE BBIE ADD CONSTRAINT BBIE_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE BBIE_SC ADD CONSTRAINT BBIE_SC_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE BCCP ADD CONSTRAINT BCCP_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE BCC ADD CONSTRAINT BCC_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE DT ADD CONSTRAINT DT_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
ALTER TABLE DT_SC ADD CONSTRAINT DT_SC_DEFINITION_ID_FK FOREIGN KEY ( DEFINITION_ID ) REFERENCES DEFINITION ( DEFINITION_ID ) NOT DEFERRABLE ;
...
CREATE OR REPLACE TRIGGER FKNTO_ABIE BEFORE
  UPDATE OF CLIENT_ID,
    DEFINITION_ID ON ABIE FOR EACH ROW BEGIN IF :old.CLIENT_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ABIE_CLIENT_ID_FK on table ABIE is violated');
END IF;
IF :old.DEFINITION_ID IS NOT NULL THEN
  raise_application_error(-20225,'Non Transferable FK constraint ABIE_DEFINITION_ID_FK on table ABIE is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_ACC BEFORE
  UPDATE OF DEFINITION_ID ON ACC FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ACC_DEFINITION_ID_FK on table ACC is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_ASBIE BEFORE
  UPDATE OF DEFINITION_ID ON ASBIE FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ASBIE_DEFINITION_ID_FK on table ASBIE is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_ASBIEP BEFORE
  UPDATE OF DEFINITION_ID ON ASBIEP FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ASBIEP_DEFINITION_ID_FK on table ASBIEP is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_ASCC BEFORE
  UPDATE OF DEFINITION_ID ON ASCC FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ASCC_DEFINITION_ID_FK on table ASCC is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_ASCCP BEFORE
  UPDATE OF DEFINITION_ID ON ASCCP FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint ASCCP_DEFINITION_ID_FK on table ASCCP is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_BBIE BEFORE
  UPDATE OF DEFINITION_ID ON BBIE FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint BBIE_DEFINITION_ID_FK on table BBIE is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_BBIEP BEFORE
  UPDATE OF DEFINITION_ID ON BBIEP FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint BBIEP_DEFINITION_ID_FK on table BBIEP is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_BBIE_SC BEFORE
  UPDATE OF DEFINITION_ID ON BBIE_SC FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint BBIE_SC_DEFINITION_ID_FK on table BBIE_SC is violated');
END IF;
END;
/

CREATE OR REPLACE TRIGGER FKNTO_BCC BEFORE
  UPDATE OF DEFINITION_ID ON BCC FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint BCC_DEFINITION_ID_FK on table BCC is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_BCCP BEFORE
  UPDATE OF DEFINITION_ID ON BCCP FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint BCCP_DEFINITION_ID_FK on table BCCP is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_DT BEFORE
  UPDATE OF DEFINITION_ID ON DT FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint DT_DEFINITION_ID_FK on table DT is violated');
END IF;
END;
/
...
CREATE OR REPLACE TRIGGER FKNTO_DT_SC BEFORE
  UPDATE OF DEFINITION_ID ON DT_SC FOR EACH ROW BEGIN IF :old.DEFINITION_ID IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint DT_SC_DEFINITION_ID_FK on table DT_SC is violated');
END IF;
END;
/
