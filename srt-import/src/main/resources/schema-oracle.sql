...
CREATE UNIQUE INDEX RELEASE_RELEASE_ID_IDX ON RELEASE
  ...
  CREATE INDEX RELEASE_CREATED_BY_IDX ON RELEASE
    ( CREATED_BY ASC
    ) ;
  CREATE INDEX RELEASE_LAST_UPDATED_BY_IDX ON RELEASE
    ( LAST_UPDATED_BY ASC
    ) ;
...
ALTER TABLE RELEASE ADD CONSTRAINT RELEASE_CREATED_BY_FK FOREIGN KEY ( CREATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;

ALTER TABLE RELEASE ADD CONSTRAINT RELEASE_LAST_UPDATED_BY_FK FOREIGN KEY ( LAST_UPDATED_BY ) REFERENCES APP_USER ( APP_USER_ID ) ;
...
CREATE OR REPLACE TRIGGER FKNTM_RELEASE BEFORE
  UPDATE OF CREATED_BY,
    LAST_UPDATED_BY ON RELEASE BEGIN raise_application_error(-20225,'Non Transferable FK constraint  on table RELEASE is violated');
END;
/
