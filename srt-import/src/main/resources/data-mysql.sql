...
VALUES
  (1, 'oagis-id-3bfbbc07cffc47a886496961b0f6b292', 0, '1.0', NULL, 'Amount', NULL, NULL, 'Amount. Type', 'Amount. Content', 'CDT V3.1. An amount is a number of monetary units specified in a currency.', 'A number of monetary units.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (2, 'oagis-id-689935c2c40445dab6ca3d19043cf71d', 0, '1.0', NULL, 'Binary Object', NULL, NULL, 'Binary Object. Type', 'Binary Object. Content', 'CDT V3.1. A binary object is a sequence of binary digits (bits).', 'A finite sequence of binary digits (bits).', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  ...
  (4, 'oagis-id-9ff8dc0294a24f7292b9fe6a8ab3a3eb', 0, '1.0', NULL, 'Date', NULL, NULL, 'Date. Type', 'Date. Content', 'CDT V3.1. A date is a Gregorian calendar representation in various common resolutions: year, month, week, day.', 'The particular point in the progression of date.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (5, 'oagis-id-c15c79d7332a47939f717943e5ed9e67', 0, '1.0', NULL, 'Date Time', NULL, NULL, 'Date Time. Type', 'Date Time. Content', 'CDT V3.1. A date time identifies a date and time of day to various common resolutions: year, month, week, day, hour, minute, second, and fraction of\nsecond.', 'The particular date and time point in the progression of time.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (6, 'oagis-id-fc2c841359814eb08104f29e02673f65', 0, '1.0', NULL, 'Duration', NULL, NULL, 'Duration. Type', 'Duration. Content', 'CDT V3.1. A duration is the specification of a length of time without a fixed start or end time, expressed in Gregorian calendar time units (Year, Month,\nWeek, Day) and Hours, Minutes or Seconds.', 'The particular representation of duration.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (7, 'oagis-id-a308345fa0614437b2593fd7cb0d9f20', 0, '1.0', NULL, 'Graphic', NULL, NULL, 'Graphic. Type', 'Graphic. Content', 'CDT V3.1. A graphic is a diagram, a graph, mathematical curves, or similar vector based representation in binary notation (octets).', 'A finite sequence of binary digits (bits) for graphics.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (8, 'oagis-id-6b35560a5ca14a1f801e9d32ff5eb502', 0, '1.0', NULL, 'Identifier', NULL, NULL, 'Identifier. Type', 'Identifier. Content', 'CDT V3.1. An identifier is a character string used to uniquely identify one instance of an object within an identification scheme that is managed by an\nagency.', 'A character string used to uniquely identify one instance of an object within an identification scheme that is managed by an agency.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  ...
  (12, 'oagis-id-d90b1011eb27451e9fedccbe7af51e76', 0, '1.0', NULL, 'Number', NULL, NULL, 'Number. Type', 'Number. Content', 'CDT V3.1. A mathematical number that is assigned or is determined by calculation.', 'Mathematical number that is assigned or is determined by calculation.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (13, 'oagis-id-6f55788519e94b9fb41c371d5c98c0ca', 0, '1.0', NULL, 'Ordinal', NULL, NULL, 'Ordinal. Type', 'Ordinal. Content', 'CDT V3.1. An ordinal number is an assigned mathematical number that represents order or sequence.', 'An assigned mathematical number that represents order or sequence', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (14, 'oagis-id-32ef31dcc7d94cc1ac34dd0067a626ed', 0, '1.0', NULL, 'Percent', NULL, NULL, 'Percent. Type', 'Percent. Content', 'CDT V3.1. A percent is a value representing a fraction of one hundred, expressed as a quotient.', 'Numeric information that is assigned or is determined by percent.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (15, 'oagis-id-1ed683abe54f496f9ba86f7ae35b703d', 0, '1.0', NULL, 'Picture', NULL, NULL, 'Picture. Type', 'Picture. Content', 'CDT V3.1. A picture is a visual representation of a person, object, or scene in binary notation (octets).', 'A finite sequence of binary digits (bits) for pictures.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (16, 'oagis-id-d05b0412061b477a82bfa4e14c2d5216', 0, '1.0', NULL, 'Quantity', NULL, NULL, 'Quantity. Type', 'Quantity. Content', 'CDT V3.1. A quantity is a counted number of non-monetary units, possibly including fractions.', 'A counted number of non-monetary units possibly including fractions.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (17, 'oagis-id-4238ca186cf6482c94b1b95fd18f2305', 0, '1.0', NULL, 'Rate', NULL, NULL, 'Rate. Type', 'Rate. Content', 'CDT V3.1. A rate is a quantity, amount, frequency, or dimensionless factor, measured against an independent base unit, expressed as a quotient.', 'The numerical value of the rate.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (18, 'oagis-id-783f8d5944054871b574e75da7dd258a', 0, '1.0', NULL, 'Ratio', NULL, NULL, 'Ratio. Type', 'Ratio. Content', 'CDT V3.1. A ratio is a relation between two independent quantities, using the same unit of measure or currency. A ratio can be expressed as either a\nquotient showing the number of times one value contains or is contained within the other, or as a proportion.', 'The quotient or proportion between two independent quantities of the same unit of measure or currency.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
  (19, 'oagis-id-b75fa46a2b884d57a46a4934cbd208c7', 0, '1.0', NULL, 'Sound', NULL, NULL, 'Sound. Type', 'Sound. Content', 'CDT V3.1. A sound is any form of an audio file such as audio recordings in binary notation (octets).', 'A finite sequence of binary digits (bits) for sounds.', NULL, 3, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0, NULL, 1, NULL, 0),
