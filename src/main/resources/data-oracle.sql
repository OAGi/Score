...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A finite sequence of binary digits (bits).', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A character string (letters, figures or symbols) that for brevity and/or language independence may be used to represent or replace a definitive value or text of an attribute.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The particular point in the progression of date.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The particular date and time point in the progression of time.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The particular representation of duration.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A finite sequence of binary digits (bits) for graphics.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A character string used to uniquely identify one instance of an object within an identification scheme that is managed by an agency.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The numeric value determined by measuring an object.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A word or phrase that represents a designation of a person, place, thing or concept.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'Mathematical number that is assigned or is determined by calculation.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'An assigned mathematical number that represents order or sequence', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'Numeric information that is assigned or is determined by percent.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A finite sequence of binary digits (bits) for pictures.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A counted number of non-monetary units possibly including fractions.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The numerical value of the rate.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The quotient or proportion between two independent quantities of the same unit of measure or currency.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A finite sequence of binary digits (bits) for sounds.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A character string generally in the form of words of a language.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'The particular point in the progression of time.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'Numeric information that is assigned or is determined by value.', '', 3,
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
...
INSERT INTO DT (DT_ID, GUID, TYPE, VERSION_NUM, PREVIOUS_VERSION_DT_ID,
  ...
  SELECT
    ...
    'A finite sequence of binary digits (bits) for videos.', '', 3, 
    APP_USER_ID, APP_USER_ID, APP_USER_ID, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    0, 0, NULL, NULL, NULL, 0
  FROM APP_USER
  WHERE LOGIN_ID = 'oagis';
