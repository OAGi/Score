...
CREATE TABLE APP_USER (
  ...
  ORGANIZATION              VARCHAR2(4000) NULL,
...
CREATE TABLE DT (
  ...
  QUALIFIER                    VARCHAR2(4000) NULL,
  BASED_DT_ID                  NUMBER(10)     NULL,
  DEN                          VARCHAR2(4000) NOT NULL,
  CONTENT_COMPONENT_DEN        VARCHAR2(4000) NULL,
  DEFINITION                   VARCHAR2(4000) NULL,
  CONTENT_COMPONENT_DEFINITION VARCHAR2(4000) NULL,
  REVISION_DOC                 VARCHAR2(4000) NULL,
...
CREATE TABLE DT_SC (
  ...
  GUID                VARCHAR2(41)   NOT NULL,
  PROPERTY_TERM       VARCHAR2(45)   NULL,
  REPRESENTATION_TERM VARCHAR2(45)   NULL,
  DEFINITION          VARCHAR2(4000) NULL,
...
CREATE TABLE BCCP (
  ...
  GUID                  VARCHAR2(41)   NOT NULL,
  PROPERTY_TERM         VARCHAR2(4000) NOT NULL,
  REPRESENTATION_TERM   VARCHAR2(4000) NOT NULL,
...
CREATE TABLE ACC (
  ...
  GUID                   VARCHAR2(41)   NOT NULL,
  OBJECT_CLASS_TERM      VARCHAR2(4000) NOT NULL,
  DEN                    VARCHAR2(4000) NOT NULL,
  DEFINITION             VARCHAR2(4000) NULL,
  BASED_ACC_ID           NUMBER(10)     NULL,
  OBJECT_CLASS_QUALIFIER VARCHAR2(4000) NULL,
...
CREATE TABLE ABIE (
  ...
  IS_TOP_LEVEL          NUMBER(3)      NOT NULL,
  BIZ_CTX_ID            NUMBER(10)     NOT NULL,
  DEFINITION            VARCHAR2(4000) NULL,
  CREATED_BY            NUMBER(10)     NOT NULL,
  LAST_UPDATED_BY       NUMBER(10)     NOT NULL,
...
CREATE TABLE AGENCY_ID_LIST (
  ...
  NAME              VARCHAR2(4000) NULL,
  LIST_ID           VARCHAR2(4000) NULL,
  AGENCY_ID         NUMBER(10)     NULL,
  VERSION_ID        VARCHAR2(4000) NULL,
  DEFINITION        VARCHAR2(4000) NULL,
...
CREATE TABLE CODE_LIST (
  ...
  NAME                  VARCHAR2(4000) NULL,
  LIST_ID               VARCHAR2(4000) NOT NULL,
  AGENCY_ID             NUMBER(10)     NOT NULL,
  VERSION_ID            VARCHAR2(4000) NOT NULL,
  DEFINITION            VARCHAR2(4000) NULL,
  REMARK                VARCHAR2(225)  NULL,
  DEFINITION_SOURCE     VARCHAR2(4000) NULL,
...
CREATE TABLE ASCCP (
  ...
  GUID                  VARCHAR2(41)   NOT NULL,
  PROPERTY_TERM         VARCHAR2(4000) NULL,
  DEFINITION            CLOB           NULL,
  ROLE_OF_ACC_ID        NUMBER(10)     NULL,
  DEN                   VARCHAR2(4000) NULL,
  CREATED_BY            NUMBER(10)     NOT NULL,
  OWNER_USER_ID         NUMBER(10)     NOT NULL,
  LAST_UPDATED_BY       NUMBER(10)     NOT NULL,
  CREATION_TIMESTAMP    TIMESTAMP      NOT NULL,
