...
CREATE TABLE `acc` (
  ...
  `module` text COMMENT 'This column stores the name of the physical schema module the ACC belongs to. Right now the schema file name is assigned. In the future, this needs to be updated to a file path from the base of the release directory.',
...
CREATE TABLE `agency_id_list` (
  ...
  `list_id` text CHARACTER SET utf8,
  `agency_id` int(11) unsigned DEFAULT NULL,
  `version_id` text CHARACTER SET utf8,
...
CREATE TABLE `asccp` (
  ...
  `property_term` text COMMENT 'There must be only one ASCCP without a Property_Term for a particular ACC.',
...
CREATE TABLE `bbie` (
  ...
  `seq_key` decimal(10,0) NOT NULL,
  `is_used` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Flag to indicate whether the field/component is used in the content model. It indicates whether the field/component should be generated.',
  PRIMARY KEY (`bbie_id`),
  UNIQUE KEY `bbie_uk1` (`guid`),
...
CREATE TABLE `bcc` (
  ...
  `seq_key` int(11) DEFAULT NULL COMMENT 'This indicates the order of the associations among other siblings. The valid values are positive integer. The Sequencing_Key at the CC side is localized. In other words, if an ACC is based on another ACC, Sequencing_Key of ASCCs or BCCs of the former ACC starts at 1 again. The Sequencing_Key in the case of Entity_Type is attribute is always zero.',
...
CREATE TABLE `biz_ctx` (
  ...
  `guid` varchar(41) NOT NULL,
  `name` text CHARACTER SET utf8 COMMENT 'Short, descriptive name of the business context.',
  `created_by` int(11) unsigned NOT NULL,
  `last_updated_by` int(11) unsigned NOT NULL,
...
CREATE TABLE `code_list` (
  ...
  `definition` text CHARACTER SET utf8,
  `remark` varchar(225) DEFAULT NULL COMMENT 'This column allows the user to codify context specific usage of the BIE. It is different from the Definition column in that the Definition column is a descriptive text while this one is machine understandable. So the data type of this column is more like code.',
  `definition_source` text CHARACTER SET utf8,
  ...
  `module` tinytext COMMENT 'The is the subdirectory and filename of the blob. The format is Windows file path. The starting directory shall be the root folder of all the release content. For example, for OAGIS 10.1 Model, the root directory is Model. If the file shall be directly under the Model directory, then this column should be ''Model\\filename.xsd''. If the file is under, say, Model\\Platform\\2_1\\Common\\Components directory, then the value of this column shall be ''Model\\Platform\\2_1\\Common\\Components\\filename.xsd''.',
  `created_by` int(11) unsigned NOT NULL,
  `last_updated_by` int(11) unsigned NOT NULL,
  `creation_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_update_timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `dt` (
  ...
  `qualifier` text CHARACTER SET utf8 COMMENT 'This column should be blank when the DT_Type is CDT. When the DT_Type is BDT, this is optional - if blank that the row is a unqualified BDT, if not blank it is a qualified BDT.',
  ...
  `module` tinytext COMMENT 'physical file where the DT shall belong to when generating it.',
...
CREATE TABLE `dt_sc` (
  ...
  `guid` varchar(41) NOT NULL,
  `property_term` varchar(45) DEFAULT NULL,
  `representation_term` varchar(45) DEFAULT NULL,
  `definition` text,
