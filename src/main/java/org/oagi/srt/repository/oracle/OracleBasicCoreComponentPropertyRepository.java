...
@Repository
public class OracleBasicCoreComponentPropertyRepository extends BaseBasicCoreComponentPropertyRepository {
    ...
    private final String SAVE_STATEMENT = "INSERT INTO bccp (" +
            ...
            "bccp_bccp_id_seq.NEXTVAL, :guid, :property_term, :representation_term, :bdt_id, :den, :definition, " +
            ":module, :namespace_id, :is_deprecated, " +
