...
@Repository
public class OracleAssociationCoreComponentRepository extends BaseAssociationCoreComponentRepository implements OracleRepository {
    ...
    private final String SAVE_STATEMENT = "INSERT INTO ascc (" +
            ...
            getSequenceName() + ".NEXTVAL, :guid, :cardinality_min, :cardinality_max, :seq_key, " +
            ":from_acc_id, :to_asccp_id, :den, :definition, :is_deprecated, " +
