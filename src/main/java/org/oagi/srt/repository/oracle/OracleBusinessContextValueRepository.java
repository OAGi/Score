...
@Repository
public class OracleBusinessContextValueRepository extends BaseBusinessContextValueRepository {

    private final String SAVE_STATEMENT = "INSERT INTO biz_ctx_value (" +
            "biz_ctx_value_id, biz_ctx_id, ctx_scheme_value_id) VALUES (" +
            "biz_ctx_value_biz_ctx_value_id.NEXTVAL, :biz_ctx_id, :ctx_scheme_value_id)";
