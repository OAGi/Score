...
@Repository
public class OracleDataTypeRepository extends BaseDataTypeRepository implements OracleRepository {
    ...
    private final String SAVE_STATEMENT = "INSERT INTO dt (" +
            ...
            getSequenceName() + ".NEXTVAL, :guid, :type, :version_num, :previous_version_dt_id, :data_type_term, :qualifier, " +
            ":based_dt_id, :den, :content_component_den, :definition, :content_component_definition, :revision_doc, :state, " +
