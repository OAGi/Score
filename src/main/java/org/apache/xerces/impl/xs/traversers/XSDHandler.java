...
public class XSDHandler {
                ...
                if (DOMUtil.getLocalName(globalComp).equals(SchemaSymbols.ELT_REDEFINE)) {
                    ...
                    redefinedComp = DOMUtil.getNextVisibleSiblingElement(redefinedComp, fHiddenNodes)) {
                        ...
                        if (redefinedComponentType.equals(SchemaSymbols.ELT_ATTRIBUTEGROUP)) {
                            ...
                            fGroupTraverser.traverseGlobal(redefinedComp, currSchemaDoc, currSG, null, null, null);
                        }
                	...
                	//System.out.println("********************* 1818 " + globalComp.getAttribute("name"));
                    fGroupTraverser.traverseGlobal(globalComp, currSchemaDoc, currSG, null, null, globalComp.getAttribute("name"));
                }
                else if (componentType.equals(SchemaSymbols.ELT_NOTATION)) {
    ...
    protected Object getGlobalDecl(XSDocumentInfo currSchema,
            int declType,
            QName declToTraverse,
            Element elmNode, String groupRef, String groupId, String groupName) {
        ...
        return traverseGlobalDecl(declType, decl, schemaWithDecl, sGrammar, groupRef, groupId, groupName);
    } // getGlobalDecl(XSDocumentInfo, int, QName):  Object
    ...
    protected Object traverseGlobalDecl(int declType, Element decl, XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
        ...
        case ELEMENT_TYPE :
            ...
            XSElementDecl xe = (XSElementDecl)retObj;
            break;
        case ATTRIBUTEGROUP_TYPE :
            retObj = fAttributeGroupTraverser.traverseGlobal(decl, schemaDoc, grammar);
            break;
        case GROUP_TYPE :
            retObj = fGroupTraverser.traverseGlobal(decl, schemaDoc, grammar, null, null, null);
            break;
        case NOTATION_TYPE :
    ...
    // TODO OAG
    protected Object traverseGlobalDecl(int declType, Element decl, XSDocumentInfo schemaDoc, SchemaGrammar grammar, String groupRef, String groupId, String groupName) {
        ...
        case ATTRIBUTEGROUP_TYPE :
            ...
            break;
        case GROUP_TYPE :
            retObj = fGroupTraverser.traverseGlobal(decl, schemaDoc, grammar, groupRef, groupId, groupName);
            break;
        case NOTATION_TYPE :
            retObj = fNotationTraverser.traverse(decl, schemaDoc, grammar);
            break;
