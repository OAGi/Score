...
class XSDAttributeTraverser extends XSDAbstractTraverser {
    ...
    XSAttributeDecl traverseNamedAttr(Element attrDecl,
        ...
        if(useAtt != null) {
        	if(useAtt.shortValue() == SchemaSymbols.USE_OPTIONAL)
        		attribute.fUse = "optional";
        	else if(useAtt.shortValue() == SchemaSymbols.USE_PROHIBITED)
        		attribute.fUse = "prohibited";
        	else if(useAtt.shortValue() == SchemaSymbols.USE_REQUIRED)
        		attribute.fUse = "required";
        }
