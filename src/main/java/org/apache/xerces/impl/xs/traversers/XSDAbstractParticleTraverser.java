...
abstract class XSDAbstractParticleTraverser extends XSDAbstractTraverser {
    ...
    XSParticleDecl traverseSequence(Element seqDecl,
            ...
            SchemaGrammar grammar,
            int allContextFlags,
            XSObject parent, boolean group, String groupGuid, String groupRef, String groupId, String groupName) {
        
        return traverseSeqChoice(seqDecl, schemaDoc, grammar, allContextFlags, false, parent, true, groupGuid, groupRef, groupId, groupName);
    }
    ...
    private XSParticleDecl traverseSeqChoice(Element decl,
        ...
        for (;child != null;child = DOMUtil.getNextSiblingElement(child)) {
            ...
            if (childName.equals(SchemaSymbols.ELT_ELEMENT)) {
                ...
                particle = fSchemaHandler.fGroupTraverser.traverseLocal(child, schemaDoc, grammar); // TODO Add to ascc
    ...
    private XSParticleDecl traverseSeqChoice(Element decl,
            ...
            int allContextFlags,
            boolean choice,
            XSObject parent, boolean isGroup, String groupGuid, String groupRef, String groupId, String groupName) {
        ...
        for (;child != null;child = DOMUtil.getNextSiblingElement(child)) {
            ...
            if (childName.equals(SchemaSymbols.ELT_ELEMENT)) {
//            	if(child != null && (child.getAttribute("id").equals("oagis-id-2a6565e2170d469f88537fe75d2542cb") || child.getAttribute("id").equals("oagis-id-93027b9cb35b4deca8c1ba70d474d24f"))) {
//            		System.out.println("### 12345678900 ###isGroup " + isGroup);
//            		System.out.println("### 12345678900 ###groupGuid " + groupGuid);
//            		System.out.println("### 12345678900 ###groupRef " + groupRef);
//            		System.out.println("### 12345678900 ###groupId " + groupId);
//            		System.out.println("### 12345678900 ###groupName " + groupName);
//            		System.out.println("### 12345678900 ###rRef " + child.getAttribute("id"));
//            	}
            	
                particle = fSchemaHandler.fElementTraverser.traverseLocal(child, schemaDoc, grammar, NOT_ALL_CONTEXT, parent);
                particle.fRef = child.getAttribute("id");
                particle.fIsGroup = isGroup;
                particle.fGroupId = groupGuid;
                particle.fGroupRef = groupRef;
                particle.fGroupParent = groupId;
                particle.fGroupName = groupName;
                
            }
            else if (childName.equals(SchemaSymbols.ELT_GROUP)) {
            	
                particle = fSchemaHandler.fGroupTraverser.traverseLocal(child, schemaDoc, grammar, child.getAttribute("id"), groupGuid, child.getAttribute("ref")); // TODO Add to ascc
                // A content type of all can only appear
                // as the content type of a complex type definition.
                if (hasAllContent(particle)) {
                    // don't insert the "all" particle, otherwise we won't be
