...
import org.oagi.srt.persistence.dto.Business_ContextVO;
...
public class Business_ContextMysqlDAO extends SRTDAO {
	...
	public boolean insertObject(SRTObject obj) throws SRTDAOException {
		...
		Business_ContextVO business_contextVO = (Business_ContextVO)obj;
		try {
	...
	public SRTObject findObject(QueryCondition qc) throws SRTDAOException {
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		Business_ContextVO business_contextVO =  new Business_ContextVO();
		try {
			Connection conn = tx.open();
