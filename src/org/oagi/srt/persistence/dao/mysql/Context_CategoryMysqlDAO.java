...
import org.oagi.srt.persistence.dto.Context_CategoryVO;
...
public class Context_CategoryMysqlDAO extends SRTDAO {
	...
	public boolean insertObject(SRTObject obj) throws SRTDAOException {
		...
		Context_CategoryVO context_categoryVO = (Context_CategoryVO)obj;
		try {
			Connection conn = tx.open();
			PreparedStatement ps = null;
			ps = conn.prepareStatement(_INSERT_CONTEXT_CATEGORY_STATEMENT);
			ps.setString(1, context_categoryVO.getName());
			ps.setString(2, context_categoryVO.getDescription());
	...
	public SRTObject findObject(QueryCondition qc) throws SRTDAOException {
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		Context_CategoryVO context_categoryVO = new Context_CategoryVO();
		try {
			Connection conn = tx.open();
