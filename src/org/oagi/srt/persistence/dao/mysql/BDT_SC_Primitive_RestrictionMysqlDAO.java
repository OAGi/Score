...
*
*/
public class BDT_SC_Primitive_RestrictionMysqlDAO extends SRTDAO {
	...
	public boolean insertObject(SRTObject obj) throws SRTDAOException {
		...
		BDT_SC_Primitive_RestrictionVO bdtscprimitiverestrictionVO = (BDT_SC_Primitive_RestrictionVO) obj;
		try {
			...
			ps.setInt(2, bdtscprimitiverestrictionVO.getBDTSCID());
			ps.setInt(3, bdtscprimitiverestrictionVO.getCDTSCAllowedPrimitiveExpressionTypeMapID());
			ps.setInt(4, bdtscprimitiverestrictionVO.getCodeListID());
			ps.setBoolean(5, bdtscprimitiverestrictionVO.getisDefault());
	...
	public SRTObject findObject(QueryCondition qc) throws SRTDAOException {
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		BDT_SC_Primitive_RestrictionVO bdtscprimitiverestrictionVO = new BDT_SC_Primitive_RestrictionVO();
