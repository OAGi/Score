...
public class ASCCMysqlDAO extends SRTDAO {
	...
	public SRTObject findObject(QueryCondition qc) throws SRTDAOException {
		...
		try {
			...
			rs = ps.executeQuery();
			if (rs.next()) {
				asccVO.setASCCID(rs.getInt("ASCC_ID")); //does the id setter get called??
	...
	public ArrayList<SRTObject> findObjects() throws SRTDAOException {
		...
		try {
			...
			rs = ps.executeQuery();
			while (rs.next()) {
				ASCCVO asccVO = new ASCCVO(); //Should this be inside loop?
				
				asccVO.setASCCID(rs.getInt("ASCC_ID")); //is the id setter supposed to be called??
				asccVO.setCardinalityMin(rs.getInt("Cardinality_Min"));
				asccVO.setCardinalityMax(rs.getInt("Cardinality_Max"));
				asccVO.setSequencingKey(rs.getInt("Sequencing_Key"));
				asccVO.setAssocFromACCID(rs.getInt("Assoc_From_ACC_ID"));
