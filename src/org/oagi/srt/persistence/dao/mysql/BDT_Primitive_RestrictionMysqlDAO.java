...
*
*/
public class BDT_Primitive_RestrictionMysqlDAO extends SRTDAO {
	...
	public boolean insertObject(SRTObject obj) throws SRTDAOException {
		...
		BDT_Primitive_RestrictionVO bdtprimitiverestrictionVO = (BDT_Primitive_RestrictionVO) obj;
		try {
	...
	public SRTObject findObject(QueryCondition qc) throws SRTDAOException {
		...
		PreparedStatement ps = null;
		ResultSet rs = null;
		BDT_Primitive_RestrictionVO bdtprimitiverestrictionVO = new BDT_Primitive_RestrictionVO();
