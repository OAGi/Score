...
public class BDT_Primitive_RestrictionMysqlDAO extends SRTDAO {
	...
	public boolean insertObject(SRTObject obj) throws SRTDAOException {
		...
		try {
			...
			ps.setInt(3, bdtprimitiverestrictionVO.getCDTPrimitiveExpressionTypeMapID());
			ps.setInt(4, bdtprimitiverestrictionVO.getCodeListID());
			ps.setBoolean(5, bdtprimitiverestrictionVO.getisDefault());
