...
public class PopulateBDT_SC_Primitive_Restriction_Temp {
	public void bdt_sc_primitive_restriction(String fileinput) throws FileNotFoundException, ParserConfigurationException, SAXException, IOException, XPathExpressionException, SRTInitializerException, SRTDAOException {
		
		DAOFactory df = DAOFactory.getDAOFactory();
		SRTDAO dao = df.getDAO("BDT_SC_Primitive_Restriction");
		BDT_SC_Primitive_RestrictionVO bdt_sc_primitive_restrictionVO = new BDT_SC_Primitive_RestrictionVO();
		
	    ArrayList<SRTObject> bdtidlist = new ArrayList<SRTObject>();
	    bdtidlist = getBDTID("TEXT",getTokenID("Token. Type"));
	...
	public static void main (String args[]) throws Exception {
		Utility.dbSetup();
		PopulateBDT_SC_Primitive_Restriction_Temp bdt_sc_primitive_restriction = new PopulateBDT_SC_Primitive_Restriction_Temp();
		String filename = "Meta" + ".xsd";
		bdt_sc_primitive_restriction.bdt_sc_primitive_restriction(filename);
	}
}
