...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:svcdoc="http://xmlns.oracle.com/Services/Documentation/V1" xmlns:ebocontext="http://xmlns.oracle.com/EBO/BusinessContext/V1" xmlns="http://www.ascc.net/xml/schematron" exclude-result-prefixes="xsi svcdoc xsd ebocontext">
			...
			<xsl:element name="rule">
				...
				<xsl:if test="local-name(.)='complexType'">
					...
					<xsl:for-each select=".//xsd:attribute">
						<xsl:element name="assert">
							<xsl:attribute name="test">count(.//xsd:attribute[@name='<xsl:value-of select="@name"/>' and @type='<xsl:value-of select="@type"/>' and <xsl:if test="count(@default) = 1">@default='<xsl:value-of select="@default"/>' and </xsl:if><xsl:choose><xsl:when test="@use = 'optional' or count(@use) = 0">(@use='optional' or count(@use) = 0)]) = 1</xsl:when><xsl:otherwise>@use='<xsl:value-of select="@use"/>']) = 1</xsl:otherwise></xsl:choose></xsl:attribute>#Issue: Checking for the attribute '<xsl:value-of select="@name"/>' declaration. The required attribute declaration does not exist or has duplicate. Maybe the value of the 'type', 'use', or 'default' attributes does not match.
					</xsl:element>
					</xsl:for-each>
				</xsl:if>
				...
				<xsl:if test="count(xsd:complexContent)=0">
					...
					<xsl:element name="assert">
						<xsl:attribute name="test">count(xsd:sequence/*) = <xsl:value-of select="count(xsd:sequence/*)"/></xsl:attribute>#Issue: The number of child elements in the 'xsd:sequence' do not match.
					</xsl:element>
					...
					<xsl:for-each select="xsd:sequence/xsd:element">
						<xsl:choose>
							<xsl:when test="count(@ref) = 1">
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@ref='<xsl:value-of select="@ref"/>']) = 1</xsl:attribute>#Issue: The xsd:element reference at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Need element '<xsl:value-of select="@ref"/>'.
								</xsl:element>
							</xsl:when>
							<xsl:otherwise>
								...
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@name='<xsl:value-of select="@name"/>' and @type='<xsl:value-of select="@type"/>']) = 1</xsl:attribute>#Issue: The local xsd:element declaration at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Need element name '<xsl:value-of select="@name"/>' and type '<xsl:value-of select="@type"/>'
								</xsl:element>
							</xsl:otherwise>
						</xsl:choose>
						<xsl:choose>
							<xsl:when test="count(@minOccurs) = 0 or @minOccurs = '1'">
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][(@minOccurs='1' or count(@minOccurs)=0)]) = 1</xsl:attribute>#Issue: The minOccurs value of the xsd:element at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is either one or the attribute does not present.
								</xsl:element>
							</xsl:when>
							<xsl:otherwise>
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@minOccurs='<xsl:value-of select="@minOccurs"/>']) = 1</xsl:attribute>#Issue: The minOccurs value of the xsd:element at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@minOccurs"/>.
								</xsl:element>
							</xsl:otherwise>
						</xsl:choose>
						<xsl:choose>
							<xsl:when test="count(@maxOccurs) = 0 or @maxOccurs = '1'">
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@maxOccurs='1' or count(@maxOccurs)=0]) = 1</xsl:attribute>#Issue: The maxOccurs value of the xsd:element at the position <xsl:value-of select="position()"/> does not match. Needed value is either one or the attribute does not present.
								</xsl:element>
							</xsl:when>
							<xsl:otherwise>
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@maxOccurs='<xsl:value-of select="@maxOccurs"/>']) = 1</xsl:attribute>#Issue: The maxOccurs value of the xsd:element at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@maxOccurs"/>.
								</xsl:element>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:for-each>
					...
					<xsl:for-each select="xsd:sequence/xsd:group">
						<xsl:element name="assert">
							<xsl:attribute name="test">count(xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@ref='<xsl:value-of select="@ref"/>']) = 1</xsl:attribute>#Issue: The xsd:group reference at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Need an xsd:group reference '<xsl:value-of select="@ref"/>'.
						</xsl:element>
						<xsl:choose>
							<xsl:when test="count(@minOccurs) = 0 or @minOccurs = '1'">
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][(@minOccurs='1' or count(@minOccurs)=0)]) = 1</xsl:attribute>#Issue: The minOccurs value of the xsd:group at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is either one or the attribute does not present. The source xsd:group name is '<xsl:value-of select="@ref"/>'. 
								</xsl:element>
							</xsl:when>
							<xsl:otherwise>
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@minOccurs='<xsl:value-of select="@minOccurs"/>']) = 1</xsl:attribute>#Issue: The minOccurs value of the xsd:group at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@minOccurs"/>. The source xsd:group name is '<xsl:value-of select="@ref"/>'. 
								</xsl:element>
							</xsl:otherwise>
						</xsl:choose>
						<xsl:choose>
							<xsl:when test="count(@maxOccurs) = 0 or @maxOccurs = '1'">
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@maxOccurs='1' or count(@maxOccurs)=0]) = 1</xsl:attribute>#Issue: The maxOccurs value of the xsd:group at the position <xsl:value-of select="position()"/> does not match. Needed value is either one or the attribute does not present. The source xsd:group name is '<xsl:value-of select="@ref"/>'.
								</xsl:element>
							</xsl:when>
							<xsl:otherwise>
								<xsl:element name="assert">
									<xsl:attribute name="test">count(xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@maxOccurs='<xsl:value-of select="@maxOccurs"/>']) = 1</xsl:attribute>#Issue: The maxOccurs value of the xsd:group at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@maxOccurs"/>. The source xsd:group name is '<xsl:value-of select="@ref"/>'.
								</xsl:element>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:for-each>
				...
				<xsl:if test="count(xsd:complexContent)=1">
					...
					<xsl:element name="assert">
						<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/*) = <xsl:value-of select="count(xsd:complexContent/xsd:extension/*)"/></xsl:attribute>
						#Issue: The number of child elements of the xsd:complexContent/xsd:extension does not match.
					</xsl:element>
					<xsl:element name="assert">
					...
					<xsl:if test="count(xsd:complexContent/xsd:extension/xsd:sequence)">
						<xsl:for-each select="xsd:complexContent/xsd:extension/xsd:sequence/xsd:element">
							<xsl:choose>
								<xsl:when test="count(@ref) = 1">
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@ref='<xsl:value-of select="@ref"/>']) = 1</xsl:attribute>
										#Issue: The xsd:element reference at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Need element '<xsl:value-of select="@ref"/>'.
									</xsl:element>
								</xsl:when>
								<xsl:otherwise>
									<!-- assuming it is the local element with the name and type attribute. In general this could be element with localized/anonymous complexType as well -->
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@name='<xsl:value-of select="@name"/>' and @type='<xsl:value-of select="@type"/>']) = 1</xsl:attribute>
										#Issue: The local xsd:element declaration at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Need element name '<xsl:value-of select="@name"/>' and type '<xsl:value-of select="@type"/>'
									</xsl:element>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:choose>
								<xsl:when test="count(@minOccurs) = 0 or @minOccurs = '1'">
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][(@minOccurs='1' or count(@minOccurs)=0)]) = 1</xsl:attribute>
									#Issue: The minOccurs value of the xsd:element at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is either one or the attribute does not present.
								</xsl:element>
								</xsl:when>
								<xsl:otherwise>
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:element[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@minOccurs='<xsl:value-of select="@minOccurs"/>']) = 1</xsl:attribute>
									#Issue: The minOccurs value of the xsd:element at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@minOccurs"/>.
								</xsl:element>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:choose>
						...
						<xsl:for-each select="xsd:complexContent/xsd:extension/xsd:sequence/xsd:group">
							...
							<xsl:choose>
								<xsl:when test="count(@minOccurs) = 0 or @minOccurs = '1'">
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][(@minOccurs='1' or count(@minOccurs)=0)]) = 1</xsl:attribute>
									#Issue: The minOccurs value of the xsd:group reference at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is either one or the attribute does not present. The source xsd:group reference is '<xsl:value-of select="@ref"/>'.
								</xsl:element>
								</xsl:when>
								<xsl:otherwise>
									<xsl:element name="assert">
										<xsl:attribute name="test">count(xsd:complexContent/xsd:extension/xsd:sequence/xsd:group[count(preceding-sibling::*) = <xsl:value-of select="count(preceding-sibling::*)"/>][@minOccurs='<xsl:value-of select="@minOccurs"/>']) = 1</xsl:attribute>
									#Issue: The minOccurs value of the xsd:group reference at the position <xsl:value-of select="count(preceding-sibling::*) + 1"/> does not match. Needed value is <xsl:value-of select="@minOccurs"/>. The source xsd:group reference is '<xsl:value-of select="@ref"/>'.
								</xsl:element>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:choose>
...
-->
	...
	Known Issues:
	1) Since we introduce the xsd:group in Version5, the uniqueness of the xsd:choice may not by the @name or @ref of the xsd:element but it may be by the @ref of the xsd:group. I have not modififed the code to take that into account. We are okay for now because we don't have an xsd:choice which contains only the xsd:group.
    -->
</xsl:stylesheet>
